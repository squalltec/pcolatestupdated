                    ...
                    <div class="cs-table cs-style1">
                        ...
                        <div class="cs-round_border">
                            <div class="cs-table_responsive">
                                <div class="d-block invoice-tbl-item-title">
                                    <!-- Hotel: <?php  ?> -->
                                    <table>
                                        <thead>
                                            <tr>
                                    ...
                                    <div class="d-block invoice-tbl-item-title">Car: <?php  ?>
                                        <table>
                                            <thead>
                                                <tr>
                                                    <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Particulars</th>
                                                    <th class="cs-width_4 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Pickup Location</th>
                                                    <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">DropOff Location</th>
                                                    <th class="cs-width_1 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Flight Details</th>
                                                    <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold cs-text_right">Total AED</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <td class="cs-width_3">
                                                        <?php
                                                        if ($triptype == 'round') {
                                                            echo '<span class="primary_bold">Arrival</span>:<br/>';
                                                            echo $car1;
                                                            echo '<br/>';
                                                            echo $arrivaldate;
                                                            echo '<br/>';
