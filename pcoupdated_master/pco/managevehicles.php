...
<?php startblock('PageContent') ?>
  ...
  <div class="form-group">
    ...
    <h2 align='center'>Manage Vehicles</h2>
          ...
          <div class="card radius-10">
            <div class="card-body">
              ...
              <div class="accordion" id="accordionExample">
                ...
                $sqll = "SELECT * FROM rentacarInventorydatabase WHERE hotel='$hotel' && country='$country' && city='$city' GROUP BY brand";
                      ...
                      <div class="accordion-item">
                        ...
                        <div id="collapse<?php echo $n; ?>" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                          <div class="accordion-body">
                            ...
                            $sqllz = "SELECT * FROM rentacarInventorydatabase WHERE hotel='$hotel' && country='$country' && city='$city' && brand='$bra' GROUP BY model";
                            ...
                            ?>
                                ...
                                <div id="collapseal<?php echo $nom; ?>" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample22">
                                  <div class="accordion-body">
                                    ...
                                    $sqllzz = "SELECT * FROM rentacarInventorydatabase WHERE hotel='$hotel' && country='$country' && city='$city' && brand='$bra' && model='$mdo' GROUP BY year";
                                    ...
                                    ?>
                                        ...
                                        <a href='editveh.php?id=<?php echo $rowwzz['id'] ?>'>
  ...
  <br />
  <br />
  <p align='center'><a href='addinventory2.php'><button class='btn btn-danger'>Add More Vehicles</button></a></p>
