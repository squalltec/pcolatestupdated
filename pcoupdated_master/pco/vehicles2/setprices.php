...
<br/>
<h1 align='center'>
<input class='btn btn-danger' type='submit' id='pds' onclick='addcardnew()' value='+'>
</h1>


<input type='submit' name='submit' value='Submit' class='btn btn-danger' style='float:right;'>
</form>
