...
$sql2 ="SELECT * FROM vehiclesInventorydatabase WHERE id='$ida' && hotel='$hon'";
...
$sql3 ="SELECT * FROM vehiclesInventorydatabase WHERE id='$idd' && hotel='$hon'";
...
if ($result3->num_rows > 0) {
  ...
  while($row3 = $result3->fetch_assoc()) {
	...
	?>
										...
										<?php
										if($arrivalenable=='true' || $departureenable=='true')
										{
										?>
