							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th>End Date</th>
										<th>Class</th>
										<th>Approved Single <br/>Rate</th>
										<th>Approved Double <br/>Rate</th>
										<th>Approval <br/>Date</th>
										<th>Release <br/>Days</th>
										<th>Comissionable</th>
										<th>Comission %</th>
										<th>Taxes <br/>Included</th>
										<th>Hotel <br/>Single<br/> Rate</th>
										<th>Hotel <br/>Double <br/>Rate</th>
								...
								<tbody>
								   ...
								   <?php
								   $an=0;
$sql ="SELECT * FROM setprices WHERE hotel='$hotel' && country='$country' && location='$city' && approved='approved'";
		$result = $conn->query($sql);
	...
	?>
							  ...
							  <input name='doubleprice[]' style='display:none;' value='<?php echo $row['dblsellprice'];?>'>	  
									...
									?>
									    ...
									    <td><?php echo $row['previoussingle'];?></td>
									    <td><?php echo $row['previousdouble'];?></td>
