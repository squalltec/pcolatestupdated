...
$sql = "INSERT INTO vehiclesInventorydatabase (hotel,country,city,brand,model,year,numberofcars)
           VALUES ('$hotel','$country','$city','$value','$model[$nn]','$year[$nn]','$numberofcars[$nn]')";
