...
foreach ($restaurantsname as $value) {
		...
		mkdir("../Facilities Images/".$hotel."/".$value, 0755, true);	
		
		 $uploadsDir2 = "../Facilities Images/".$hotel."/".$value."/";
        $allowedFileType = array('jpg','png','jpeg');
                ...
                if(!empty($sqlVal)) {
                    $insert = $conn->query("INSERT INTO facilitiesimages (hotel, country,location,facilities,image) VALUES ('$hotel', '$country', '$city', '$value','$fileName')");
...
$sqlTpl1 = "INSERT INTO facilities (hotel,country,location,facilities,description) VALUES (%s )";
...
$des=mysqli_real_escape_string($conn, $_POST['des']);	
		...
		mkdir("../Facilities Images/".$hotel."/".$value, 0755, true);	
		 ...
		 $uploadsDir = "../Facilities Images/".$hotel."/".$value."/";
        $allowedFileType = array('jpg','png','jpeg');
...
$sql ="UPDATE facilities SET description='$des' WHERE id='$id'";
...
<h2 style='margin-top:-50px;' align='center'>Manage Facilities</h2>
...
$sqll ="SELECT * FROM facilities WHERE hotel='$hotel' && country='$country' && location='$city'";
  ...
  while($roww = $resultt->fetch_assoc()) {
	...
	?>
             <form action="#" method="post" enctype="multipart/form-data">       
                ...
                <input class='form-control' readonly value='<?php echo $roww['facilities'];?>' id='facility' name='facility'> 
                        ...
                        <div id="collapse<?php echo $n;?>" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                          <div class="accordion-body">
                           ...
                           <label>Facility Images:</label><br/>
                           
                           <?php 
                           
                           $tpe=$roww['facilities'];
                                               
$sqllv ="SELECT * FROM facilitiesimages WHERE hotel='$hotel' && country='$country' && location='$city' && facilities='$tpe'";
  ...
  while($rowwv = $resulttv->fetch_assoc()) {
	  $aid=$rowwv['id'];
                           ...
                           ?>
                            ...
                            <a href='del.php?tbl=facilitiesimages&aid=<?php echo $aid;?>'><b><span style='font-size:2em; position:absolute; z-index:1; color:red;'>&times;</span></b> </a>
                           
                           <img style="width:100px;" src='../Facilities Images/<?php echo $hotel;?>/<?php echo $tpe;?>/<?php echo $rowwv['image'];?>'>
...
<div class="container">
       <div class='row'>
        <label>Add More Facilities</label>
        <div id='aacctt2'>
           <div class="col-sm">
               
                  <input type='text' placeholder='Facility Name' class="form-control" id='restaurantsname[]' name='restaurantsname[]'>
                  
                 
                  
                  <textarea class="form-control" placeholder='Facility Description' id='restaurantsdes[]' name='restaurantsdes[]'></textarea>
   ...
   <div class="form-group">
 <button style="float:right;"type="submit" name='addnew' class="btn btn-danger">Add New</button>
  </div>
...
yc.setAttribute("placeholder", "Facility Name");
...
yc2.setAttribute("placeholder", "Facility Description");
