...
?>
                     ...
                     <a href='updatevenue.php?hotel=<?php echo $rowwa['hotel']?>&venue=<?php echo $rowwa['venue']?>&country=<?php echo $rowwa['country']?>&city=<?php echo $rowwa['city']?>'> <div class="accordion-item">
