...
<select class="form-control" name="backfront">
    <?php
    if($row['backfront']=='Back Projection')
    {
        echo '<option>Back Projection</option>';
       echo '<option>Front Projection</option>';
       
    }
     else if($row['backfront']=='Front Projection')
    {
       ...
       echo '<option>Back Projection</option>';
         ...
         echo '<option>Back/Front Projection?</option>';
       echo '<option>Front Projection</option>';
       echo '<option>Back Projection</option>';
