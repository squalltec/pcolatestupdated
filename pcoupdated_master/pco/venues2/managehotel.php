...
$sql ="UPDATE venuedatabase SET name='$hotel',country='$country',city='$city',gps='$gps',telephone='$telephone',area='$area',description='$description',parking='$parking',chargednotcharged='$chargednotcharged',atm='$atm',highlights='$highlights',acceptedcardslist='$acceptedcardslist' WHERE name='$hotel' && country='$country' && city='$city'";
...
<h2 style='margin-top:-50px;' align='center'>Manage Location</h2>
...
if ($resulto->num_rows > 0) {
  ...
  while($rowo = $resulto->fetch_assoc()) {
     ...
     <a href='del.php?tbl=venuedatabaseimages&aid=<?php echo $aid;?>'><b><span style='font-size:2em; position:absolute; z-index:1; color:red;'>&times;</span></b> </a>
   
   <img style=" position: relative; width:300px;" src='../Venue Location Images/<?php echo $hotel;?>/<?php echo $rowo['image']; ?>'>
