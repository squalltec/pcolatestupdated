...
if (isset($_POST['submit'])) {
	...
	$getadults = $_POST['adults'];
	$getchildren = $_POST['children'];
	
	

	
	foreach ($getadults as $value) {
	
	array_push($adults,$value);
...
$sqlTpl = "INSERT INTO allowedpersons ( hotel,country,location,name, adults,children,max)
           VALUES (%s )";
...
$mx= (int)$adults[$k]+(int)$children[$k];


  $sqlArr[] = '"'.$hotelnaam.'","'.$countrynaam.'","'.$locationnaam.'","'.$types[$k].'","'.$adults[$k].'","'.$children[$k].'","'.$mx.'"';
...
foreach ($types as $value) {
	...
	//echo "<script>alert('a');</script>";
		...
		mkdir("Room Uploads/".$hotelnaam."/".$value, 0755, true);	
		
		 $uploadsDir = "Room Uploads/".$hotelnaam."/".$value."/";
...
var line = document.createElement("hr");
var l = document.createElement("label");
l.innerHTML="Occupancy: ";

var y = document.createElement("INPUT");
y.setAttribute("type", "number");
y.setAttribute("class", "form-control");
y.setAttribute("id","adults[]");
y.setAttribute("Name", "adults[]");
y.setAttribute("Placeholder", "Adults");
...
y.setAttribute("type", "number");
y.setAttribute("class", "form-control");
y.setAttribute("id","children[]");
y.setAttribute("Name", "children[]");
y.setAttribute("Placeholder", "Children");
...
l.innerHTML="Upload Multiple Images: ";
