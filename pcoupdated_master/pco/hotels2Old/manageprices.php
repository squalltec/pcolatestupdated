  ...
  while($roww = $resultt->fetch_assoc()) {
	...
	?>
                   ...
                   <h2 class="accordion-header" id="headingOne">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsea<?php echo $nz;?>" aria-expanded="true" aria-controls="collapsea<?php echo $n;?>">
                           <label>Room:&nbsp; </label><br/>
...
<br/>
<br/>
<p align='center'><a href='add_new_prices_outside.php'><button class='btn btn-danger'>Add More FIT Prices</button></a></p>


<p align='center'><a href='add_new_prices.php'><button class='btn btn-danger'>Add More Event Prices</button></a></p>
