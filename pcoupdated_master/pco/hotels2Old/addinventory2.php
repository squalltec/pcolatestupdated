...
<input align="left" type="checkbox" style='display:none;' name="singledouble[]"><label style='display:none;'> Doesn't Have Double?</label>
					...
					<input class="form-control"  name="doublesize[]" placeholder="Double Size">
									...
									<td>
									    	...
									    	<nonsense style='float:right;'>or</nonsense>
									    		<input class="form-control"  name="alternativesingleadultssleep[]" placeholder="Single Adults Sleeps">
									</td>
									<td>
									   <input class="form-control"  name="singlechildrensleep[]" placeholder="Single Children Sleeps">
									  <br/>
									    	<input class="form-control"  name="alternativesinglechildrensleep[]" placeholder="Single Children Sleeps">
									</td>
									<td>
		<input class="form-control" name="singleextrabedsleep[]" placeholder="Single Extra Beds">
									...
									<td>
									    	<input class="form-control"  name="doubleadultssleep[]" placeholder="Double Adults Sleeps">
									    		<nonsense style='float:right;'>or</nonsense>
									    			<input class="form-control"  name="alternativedoubleadultssleep[]" placeholder="Double Adults Sleeps">
									</td>
									<td>
									   <input class="form-control"  name="doublechildrensleep[]" placeholder="Double Children Sleeps">
									   <br/>
									   <input class="form-control"  name="alternativedoublechildrensleep[]" placeholder="Double Children Sleeps">
									</td>
									<td>
...
non.innerHTML='or';
non.setAttribute('style','float:right;');
var yc3new = document.createElement("INPUT");

yc3new.setAttribute("class", "form-control");
yc3new.setAttribute("Name", "alternativesingleadultssleep[]");
yc3new.setAttribute("placeholder", "Single Adults Sleep");
td4.appendChild(non);
td4.appendChild(yc3new);
//asjkdjaskjdaskdasd
...
var yca1new = document.createElement("INPUT");

yca1new.setAttribute("class", "form-control");
yca1new.setAttribute("Name", "alternativesinglechildrensleep[]");
yca1new.setAttribute("placeholder", "Single Children Sleep");
tda1.appendChild(br);
tda1.appendChild(yca1new);
...
var nona = document.createElement("NONSENSE");
nona.innerHTML='or';
nona.setAttribute('style','float:right;');
var yca3new = document.createElement("INPUT");

yca3new.setAttribute("class", "form-control");
yca3new.setAttribute("Name", "alternativedoubleadultssleep[]");
yca3new.setAttribute("placeholder", "Double Adults Sleep");
tda3.appendChild(nona);
tda3.appendChild(yca3new);
...
var yca1newa = document.createElement("INPUT");

yca1newa.setAttribute("class", "form-control");
yca1newa.setAttribute("Name", "alternativedoublechildrensleep[]");
yca1newa.setAttribute("placeholder", "Double Children Sleep");
tda4.appendChild(bra);
tda4.appendChild(yca1newa);
