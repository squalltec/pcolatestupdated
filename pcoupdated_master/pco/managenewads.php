...
<div class="row">
              <div class="col col-lg-9 mx-auto">
                ...
                <div class="card radius-10">
                  <div class="card-body">
                    <h5 class="card-title">Ads Providers</h5>
...
?>
                     ...
                     <a href='advertisement2/redirecter.php?hotel=<?php echo $rowwa['name']?>&country=<?php echo $rowwa['country']?>&city=<?php echo $rowwa['city']?>&star=<?php echo $rowwa['star']?>'> <div class="accordion-item">
