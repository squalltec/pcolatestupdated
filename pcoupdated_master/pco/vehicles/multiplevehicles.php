...
<h1 align='center'>Choose Company</h1>
...
$n=0;
 ...
 $sqllas = "SELECT * FROM loginforvehicles WHERE email = '$email' && password= '$password'";
...
$m=0;
 ...
 $sqllas = "SELECT * FROM transportusers WHERE email = '$email' && password= '$password'";
