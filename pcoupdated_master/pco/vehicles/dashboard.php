...
$sql2 = "UPDATE loginforvehicles SET password='$passwordnew' WHERE email='$email'";
...
$sql3 = "UPDATE transportusers SET password='$passwordnew' WHERE email='$email'";
...
while($row=mysqli_fetch_assoc($result)){
 ...
 $sqllas = "SELECT * FROM transportusers WHERE email = '$email'";
...
echo '<br/><a href="multiplevehicles.php" style="float:right;" class="btn btn-danger">Switch</a><br/><br/><br/>';
