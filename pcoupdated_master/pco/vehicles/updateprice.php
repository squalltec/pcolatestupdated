...
$sql2 = "UPDATE setprices SET hotel='$hotel',country='$country',location='$city',name='$room',sellprice='$single',dblsellprice='$double',sdate='$sdate',edate='$edate',event='$event' WHERE id='$setpricesid'";
      ...
      <div class='row'>
         ...
         <div class="col-sm">
              ...
              <label>Single Price</label>
                 <input class='form-control' value='<?php echo $singlez;?>' required name='single' placeholder='Single Price' min='0' type='number'>
             ...
             <div class="col-sm">
              ...
              <label>Double Price</label>
                 <input class='form-control' value='<?php echo $doublez;?>' name='double' placeholder='Double Price' min='0' type='number'>
