...
Access System: <a href="https://squalltec.com/pcoupdated_master/pco/venues/">Click Here</a><br/><br/>
...
$sql ="INSERT INTO loginforvenues (country, city,name,email,password) VALUES ('$country', '$city', '$name', '$email', '$password')";
...
<h2 style='margin-top:-50px;' align='center'>Register Location for Venues</h2>
<br/><br/>
...
if ($resultt->num_rows > 0) {
  ...
  while($roww = $resultt->fetch_assoc()) {
    ...
    <input type="text" list='listhotels' class="form-control" name='name' id='name' placeholder="Location Name">
