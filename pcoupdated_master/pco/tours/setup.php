...
$sqll ="SELECT * FROM toursdatabase WHERE name='$hotel'";
...
if(!empty($_FILES['logo']['name'])){
		...
		mkdir("../Tours Logos/".$hotel, 0755, true);	
	
		$filename2 = $_FILES['logo']['name'];
	  $destination2 = '../Tours Logos/'.$hotel.'/'. $filename2;
...
$sqlx ="INSERT INTO tourslogos (hotel,country,city, image) VALUES ('$hotel', '$country', '$city', '$filename2')";
...
if(!empty($_FILES['lisence']['name'])){
		mkdir("../Tours Lisences/".$hotel, 0755, true);	
	
		$filename22 = $_FILES['lisence']['name'];
	  $destination22 = '../Tours Lisences/'.$hotel.'/'. $filename22;
...
$sqlxx ="INSERT INTO tourslisences (hotel,country,city, lisence) VALUES ('$hotel', '$country', '$city', '$filename22')";
...
$sql ="INSERT INTO toursdatabase (name,country,city,gps,telephone,description,address,cards,acceptedcardslist,built) VALUES ('$hotel', '$country', '$city', '$gps', '$telephone', '$description', '$address','$cards','$acceptedcardslist','$built')";
...
if ($result === TRUE) {
 ...
 $_SESSION['alertme']=2;
 echo "<script>location.replace('addinventory2tours.php');</script>"; 
