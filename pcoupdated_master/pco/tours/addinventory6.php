...
$sql1 ="SELECT * FROM vehiclesinclusive WHERE name='$value'";
...
$sqlbb="INSERT INTO vehiclesinclusive (name) VALUES ('$value')";
...
$sqlo ="UPDATE vehiclesInventorydatabase SET inclusivefree='$inroomfacilities' WHERE hotel='$hotel' && country='$country' && city='$city' && brand='$brandd' && model='$roomtype'";
