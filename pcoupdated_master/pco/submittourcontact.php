...
$sql ="INSERT INTO contactstour (company,country,city,fname,lname,email,designation,department,outlet,phone,nationality,birthday) VALUES ('$hotel','$country','$city','$fname','$lname','$email','$designation','$department','$outlet','$phone','$nationality','$birthday')";
