...
$sql ="UPDATE newrentacarpricesdis SET markup='$markup[$n]' , amorper='$type[$n]',approvedornot='approved',approveddate='$today' WHERE id='$id'";
 ...
 ?>
  ...
  <link href="assets/css/header-colors.css" rel="stylesheet" />
		...
		<td><select id='typer' style='border:1px red solid;' class='form-select'>
								   ...
								   <?php
								   $an=0;
$sql ="SELECT * FROM newrentacarpricesdis WHERE name='$hotel' && country='$country' && city='$city' && approvedornot=''";
		$result = $conn->query($sql);
