...
Password: '.$pas.'<br/>
Access System: <a href="https://squalltec.com/pco_master/vehicles/">Click Here</a><br/><br/>
...
$sql ="INSERT INTO vehiclescontactdatabase (company,country,city,fname,lname,email,designation) VALUES ('$hotel','$country','$city','$fname','$lname','$email','$designation')";
...
?>
  ...
  <div class="form-group">
    <label>Email</label>
    <input class="form-control" name='email' id='email' type='email' required placeholder="xxxxx@example.com">
  </div>
