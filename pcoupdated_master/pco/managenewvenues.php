...
$sqlla ="SELECT * FROM loginforvenues";
...
?>
                     ...
                     <a href='venues2/redirecter.php?hotel=<?php echo $rowwa['name']?>&country=<?php echo $rowwa['country']?>&city=<?php echo $rowwa['city']?>&star=<?php echo $rowwa['star']?>'> <div class="accordion-item">
