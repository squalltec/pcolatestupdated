...
<div>
    ...
    <input list='ht' type="text" class="form-control" name='hotelname' id='hotelname' required placeholder="Hotel">

<datalist id='ht' style='display:none;'class='form-control'>
      <?php
         
					   $sqllas = "SELECT * FROM contactsothers GROUP BY hotel";
