...
$sql = "SELECT * FROM setprices WHERE hotel='$hotel' && country='$country' && location='$city' && class='FIT'";
...
if ($row['cancellationdescription'] == '') {
   ...
   if ($row['psdates'] == '') {
            ...
            array_push($psdates, $row['psdates']);
        }

  if ($row['pedates'] == '') {
            array_push($pedates, '-');
        } else {
            array_push($pedates, $row['pedates']);
        }
            ...
            <tr>
                ...
                ?>
                    ...
                    <td colspan='2'>
                        ...
                        <?php
                        $singleratea = 0;
                        $sql = "SELECT * FROM setprices WHERE hotel='$hotel' && country='$country' && location='$city' && name='$type' && class='FIT' && sdate='$startdates[$mama]' && edate='$enddates[$mama]'";
...
Rate Percentage
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            $cd=explode(",",$cancellationpercentage[$n2]); 
 ...
 <td colspan='10'>
                      ...
                      <?php
                            ...
                            $ps=explode(",",$psdates[$n2]); 
                            $pe=explode(",",$pedates[$n2]); 
                            
                            $n=0;
                            foreach($ps as $cc)
                            {
                                if(($ps[$n]=='-' && $pe[$n]=='-')|| ($ps[$n]=='' && $pe[$n]=='') )
                ...
                <tr>
                    <td style='color:white; background-color:black;' colspan='32'><b>
                            Supplements
                        </b>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan='28'><?php echo $breakfast; ?></td>

                </tr>
                <tr>

                    <td colspan='4'>Lunch</td>
                    <td colspan='28'><?php echo $lunch; ?></td>
                ...
                <tr>
                    ...
                    <td colspan='28'><?php echo $dinner; ?></td>

                </tr>
                <tr>

                    <td colspan='4'>Extra Bed</td>
                    <td colspan='28'><?php echo $extrabed; ?></td>
                ...
                <tr>
                    ...
                    <td colspan='28'><?php echo $childbed; ?></td>
                ...
                <tr>
                    ...
                    <td colspan='28'><?php echo $babycot; ?></td>
