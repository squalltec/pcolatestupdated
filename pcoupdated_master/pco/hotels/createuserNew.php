...
if (isset($_POST['delme'])) {
	...
	$sql = "DELETE FROM hotelusers WHERE id='$aidii'";
...
if (isset($_POST['submit'])) {
	...
	foreach ($fname as $value) {
		...
		$sql = "INSERT INTO hotelusers (hotel,country,city,star,fname,lname,designation,department,phone,nationality,birthday,role,email,password,uniqueid)
		...
		<div class="table-responsive mt-3">
			<table class="table align-middle" style="border: 1px solid #ce3435;">
				...
				<tbody>
					...
					$sql = "SELECT * FROM hotelusers WHERE hotel='$han' && country='$can' && city='$ctan'";
