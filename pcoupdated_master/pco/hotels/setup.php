...
*/
  ...
  $sql = "INSERT INTO hotelsdatabase (name, star,country,city,type,gps,telephone,area,description,address,view,pool,highlights,beach,renovatedon,built,restauranttype) VALUES ('$hotel', '$star', '$country', '$city', '$type', '$gps', '$telephone', '$area', '$description', '$address','$view','$pool','$highlights','$beach','$renovatedon','$built','$restauranttype')";
...
<div class="col-sm">
                <div class="form-group">
                  <input type="text" class="form-control" name='restauranttype' placeholder="Restaurant Type">
                </div>
              </div>
              <div id='popme'>
              </div>
