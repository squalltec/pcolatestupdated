...
<link href="http://fonts.cdnfonts.com/css/crossten" rel="stylesheet">
<link href="http://fonts.cdnfonts.com/css/astoriaroman" rel="stylesheet">
<style>
  .card:hover {
  ...
  body {
    background-image: url('./assets/images/hotelsDubai2.webp');
  ...
  <div class="container col-md-6 pt-5">
    ...
    <div class="row">
      <div class="col-md-12 d-flex justify-content-center">
        <h1 class="text-light">Choose Hotel</h1>
      </div>
    </div>
    ...
    $sqllas = "SELECT * FROM loginforhotels WHERE email = '$email' && password= '$password'";
    ...
    $sqllas = "SELECT * FROM hotelusers WHERE email = '$email' && password= '$password'";
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <p align='center'><input type='submit' name='submit' class="btn btn-danger" value='Open'></p>
                </div>
              </div>
            </div>
          </div>
