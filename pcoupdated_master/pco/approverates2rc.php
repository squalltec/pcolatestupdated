							...
							<table id="example2" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th>Approved Price Daily</th>
										<th>Approved Price Weekly</th>
										<th>Approved Price Monthly</th>
										<th>Day Price By Company</th>
										<th>Weekly Price By Company</th>
										<th>Monthly Price By Company</th>
										<th>Approved Date</th>
  ...
  while($row = $result->fetch_assoc()) {
	...
	?>
									...
									<tr>
										...
										<td>
										    <?php echo $row['markupamount'];?>
										</td>	
										<td>
										    <?php echo $row['aorp'];?>
										</td>	
									    <td><?php echo $row['pricem'];?></td>
									    <td><?php echo $row['pricemweekly'];?></td>
									    <td><?php echo $row['pricemmonthly'];?></td>
									    <td><p><?php echo $row['previousprice'];?></p></td>
									    <td><p><?php echo $row['previouspriceweekly'];?></p></td>
									    <td><p><?php echo $row['previouspricemonthly'];?></p></td>
