...
$c=isset($_POST['cla']) ? "1" : "0";

$p=isset($_POST['pre']) ? "1" : "0";

$pp=isset($_POST['prep']) ? "1" : "0";

$cr=isset($_POST['clbr']) ? "1" : "0";

$ps=isset($_POST['pres']) ? "1" : "0";

$fr=isset($_POST['famr']) ? "1" : "0";
...
$sql ="INSERT INTO hotels (name, description,category,image,country,location,c,p,pp,cr,ps,fr) VALUES ('$name', '$des', '$category', '$filename', '$country', '$location', '$c', '$p', '$pp', '$cr', '$ps', '$fr')";
...
<option value="Zimbabwe">Zimbabwe</option>
  ...
  <label><b>Room Types:</b></label>
  
  <div class="form-group">
    <label>Classic Room</label>
	
    <input type="checkbox"  name='cla'>
	<br/>
	
	<label>Premium Room</label>
	...
	<label>Club Room</label>
	
    <input type="checkbox"  name='clbr'>
	<br/>
