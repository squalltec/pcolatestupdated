...
if (isset($_POST['submit'])) {
  ...
  $sql2 = "UPDATE setprices SET hotel='$hotel',country='$country',location='$city',name='$room',sellprice='$single',dblsellprice='$double',sdate='$sdate',edate='$edate', approved='' WHERE id='$setpricesid'";
  ...
  <div class="card-body">
    <form action="#" method="post" enctype="multipart/form-data">
      ...
      <div class='row'>
        ...
        $sqllvrz = "SELECT * FROM setprices WHERE hotel='$hotel' && country='$country' && location='$city' && name='$getroom' && sdate='$getsdate' && edate='$getedate' && class='FIT'";
        ...
        $sqllvrzx = "SELECT * FROM basiccharges WHERE hotel='$hotel' && country='$country' && location='$city' && roomname='$getroom' && sdate='$getsdate' && edate='$getedate'";
