		 ...
		 <li>
			...
			<li>
              ...
              <a href="managegeneralfacilities.php" >
				...
				<li>
              <a href="addplanner11.php" >
                <div class="parent-icon"><i class="bi bi-house-fill"></i>
                </div>
                <div class="menu-title">Add Banquet and Meeting Planner</div>
              </a>
              ...
              <a href="managevenues.php" >
                ...
                <div class="menu-title">Manage Banquet and Meeting Planner</div>
              </a>
              ...
              <a href="manageinventory.php" >
            	...
            	<li>
              <a href="manageprices.php" >
                <div class="parent-icon"><i class="bi bi-house-fill"></i>
                </div>
                <div class="menu-title">Manage Room Rates</div>
              </a>
              ...
              <a href="managerestaurants.php" >
                ...
                <div class="menu-title">Manage Restaurants</div>
              </a>
            ...
            <li>
             ...
             <li>
              <a href="cancellationbookings.php" >
                <div class="parent-icon"><i class="bi bi-house-fill"></i>
                </div>
                <div class="menu-title">Cancellation Requests</div>
              </a>
          ...
          if(strpos($roler, 'management')!== false)
          {
			...
			<li>
              ...
              <a href="managegeneralfacilities.php" >
				...
				<li>
              <a href="addplanner.php" >
                <div class="parent-icon"><i class="bi bi-house-fill"></i>
                </div>
                <div class="menu-title">Banquet and Meeting Planner</div>
              </a>
