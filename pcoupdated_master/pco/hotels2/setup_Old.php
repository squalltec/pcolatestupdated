...
$agerestriction=mysqli_real_escape_string($conn, $_POST['agerestriction']);
$roomservicefrom=mysqli_real_escape_string($conn, $_POST['roomservicefrom']);
$roomserviceto=mysqli_real_escape_string($conn, $_POST['roomserviceto']);
...
$sql ="INSERT INTO hotelsdatabase (name, star,country,city,type,gps,telephone,area,description,address,view,pool,agerestriction,roomservicefrom,roomserviceto,cards,highlights,parking,atm,chargednotcharged,beach,acceptedcardslist,renovatedon,built,parkingcharges) VALUES ('$hotel', '$star', '$country', '$city', '$type', '$gps', '$telephone', '$area', '$description', '$address','$view','$pool','$agerestriction','$roomservicefrom','$roomserviceto','$cards','$highlights','$parking','$atm','$chargednotcharged','$beach','$acceptedcardslist','$renovatedon','$built','$parkingcharges')";
...
<h2 style='float:left; margin-top:-100px;' align='center'>Hotel Setup</h2>
...
<small>Max 2mb (1000px x 1000px)</small>
  ...
  <div style='display:none;' class="col-sm" id='numberofpoolsdiv'>
      ...
      <input id='numberofpools' class='form-control' type='number'>
  ...
  <div class="container">
   ...
   <div class="form-group">
    <label>Minimum Age Restriction for Checking In</label>
    <input type="number" class="form-control" required name='agerestriction'>
  </div>
  </div>
