...
$sql2 = "INSERT INTO setprices (hotel,country,location,name,sellprice,dblsellprice,sdate,edate,class,releasedays,dates,commisionable,commision,including,sameid,rateregions)
           VALUES ('$hotel','$country','$city','$room[$n]','$single[$n]','$double[$n]','$sdate','$edate','$class','$release[$n]','$newdate','$commisionable[$n]','$commision[$n]','$tt','$samerand','$rateregions')";
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
  ...
  <!--start content-->
          <main class="page-content">
              ...
              <h1 style='margin-top:-60px;' align='center'>Add Regional Prices</h1>
...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'Paris')" id="defaultOpen">Regional</button>
</div>
...
<form action="#" method="post" enctype="multipart/form-data">
 ...
 <select class='form-control'  required id="choices-multiple-remove-button" name='regions[]' placeholder="Select Regions" multiple>
   
   
   
   <?php
   
   $sqlzl ="SELECT * FROM regionspecified WHERE company='$hotel' GROUP BY region";
...
if ($resultzt->num_rows > 0) {
  ...
  while($rowwz = $resultzt->fetch_assoc()) {
      ...
      echo '<option>'.$rowwz['region'].'</option>';
  }
}
      ?>
