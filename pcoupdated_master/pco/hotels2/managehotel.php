...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE hotelsdatabase SET name='$hotel', star='$star',country='$country',city='$city',type='$type',gps='$gps',telephone='$telephone',area='$area',description='$description', beach='$beach', view='$view', highlights='$highlights' WHERE name='$hotel' && country='$country' && city='$city' && star='$star'";
