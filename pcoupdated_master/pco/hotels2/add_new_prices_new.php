...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
  <div class="breadcrumb-title pe-3">Add New Event Prices</div>
                    ...
                    <tbody id='populateme<?php echo $a; ?>'>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <input type='number' style='display:none;' min='0' name='commision[]' id='co<?php echo $a; ?>' placeholder='Commission' class='form-control'>
                        </td>
                        <td>
...
<script>
  ...
  function myFunction2new() {
    ...
    row.classList.add('PositionRelative');
