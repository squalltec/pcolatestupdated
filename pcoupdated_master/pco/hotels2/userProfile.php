...
if(isset($_GET['uid'])){
	$userId = $_GET['uid'];
	$sql = "SELECT * FROM hotelusers WHERE id = $userId LIMIT 1";
...
$sql2 = "UPDATE hotelusers SET fname='$fname',lname='$lname',designation='$designation',department='$department',nationality='$nationality',phone='$phone',birthday='$birthday',email='$email',password='$password' WHERE id='$id'";
