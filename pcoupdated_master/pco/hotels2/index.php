...
$result = mysqli_query($conn, "SELECT * FROM loginforhotels WHERE email = '" . $email. "' and password = '" . $password. "'");
if(!empty($result)){
...
VALUES ('".$row['name']."', '".$row['country']."', '".$row['city']."','admin','$date','$time','$countrytocheck','hotel','$user_ip')";
...
if ($conn->query($sql) === TRUE) {
 ...
 // echo "Error: " . $sql . "<br>" . $conn->error;
	...
	header("Location: multiplehotels.php");
  ...
  $result2 = mysqli_query($conn, "SELECT * FROM hotelusers WHERE email = '" . $email. "' and password = '" . $password. "'");
if(!empty($result2)){
...
VALUES ('".$row2['hotel']."', '".$row2['country']."', '".$row2['city']."','".$row2['role']."','$date','$time','$countrytocheck','hotel', '".$row2['fname']."', '".$row2['lname']."', '".$row2['designation']."','$user_ip')";
