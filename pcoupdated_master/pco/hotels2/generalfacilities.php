...
<input type='submit' id='pds' onclick='addcardnew()' value='+'>
  ...
  <div class="tab"><h3>Facilities:</h3>
   <div id='cardslist' class="container">
      <div class='row'>
...
<input type='submit' id='pdss' onclick='addcardneww()' value='+'>
   ...
   <div class="tab"><h3>Front Desk:</h3>
  <div class="container">
      <div class='row'>
...
<input type='submit' id='pdsss' onclick='addcardnewww()' value='+'>
   ...
   <div class="tab"><h3>Family Services:</h3>
...
<input type='submit' id='pdssss' onclick='addcardnewwww()' value='+'>
   ...
   <div class="tab"><h3>Sports & Fitness</h3>
...
<input type='submit' id='pdssss2' onclick='addcardnewwww2()' value='+'>
   ...
   <div class="tab"><h3>Cleaning Services</h3>
   <div class="container">
      <div class='row'>
...
<input type='submit' id='pdssss23' onclick='addcardnewwww23()' value='+'>
   ...
   <div class="tab"><h3>Business Facilities:</h3>
    <div class="container">
      <div class='row'>
...
<input type='submit' id='pdssss2345' onclick='addcardnewwww2345()' value='+'>
   ...
   <div class="tab"><h3>Food & Drink:</h3>
    <div class="container">
      <div class='row'>
...
<input type='submit' id='pdssss234567' onclick='addcardnewwww234567()' value='+'>
   ...
   <div class="tab"><h3>Unique Features</h3>
   <div class="container">
      <div class='row'>
...
<input type='submit' id='pdssss2345678' onclick='addcardnewwww2345678()' value='+'>
   ...
   <div class="tab"><h3>Safety & Security Features</h3>
    <div class="container">
      <div class='row'>
...
<!--tabs end-->
  ...
  <button type='submit' name='submit' class='btn btn-danger' id='smbt' style='display:none; float:right;'>Submit</button>
