...
$n=0;
 $sqllas = "SELECT * FROM loginforvenues WHERE email = '$email'";
...
while($row=mysqli_fetch_assoc($result)){
 ...
 $sqllas = "SELECT * FROM venueusers WHERE email = '$email'";
...
echo '<br/><a href="multiplevenues.php" style="float:right;" class="btn btn-danger">Switch</a><br/><br/><br/>';
