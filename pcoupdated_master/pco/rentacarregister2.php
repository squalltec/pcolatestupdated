...
Access System: <a href="https://squalltec.com/pcoupdated_master/pco/rent/">Click Here</a><br/><br/>
...
$sql ="INSERT INTO loginforrentacar (country, city,name,email,password) VALUES ('$country', '$city', '$name', '$email', '$password')";
...
<h2 style='margin-top:-50px;' align='center'>Create Rent a Car Company</h2>
<br/><br/>
...
if ($resultt->num_rows > 0) {
  ...
  <div class='container'>
    ...
    <label>Designation</label>
     ...
     <input type="text" class="form-control" readonly name='designtaion' id='designation' placeholder="Designation">
...
listhotels.innerHTML='';
 ...
 $.ajax({
              type:'POST',
              url:'getrentacarbycityfromcontacts.php',
...
$.ajax({
              type:'POST',
              url:'getemailofcontactrentacar.php',
...
$.ajax({
              type:'POST',
              url:'getdesignationofcontactrentacar.php',
              data:{'fullname':fullname,'name':name,'country':country,'city':city},
...
$.ajax({
 ...
 $.ajax({
              type:'POST',
              url:'validaterentacarregistered.php',
...
document.getElementById('name').value='';
              ...
              contactlist.innerHTML='';     
                ...
                $.ajax({
              type:'POST',
              url:'getcontactslistrentacar.php',
              data:{'name':name,'country':country,'city':city},
