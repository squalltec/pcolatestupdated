...
Access System: <a href="https://squalltec.com/pcoupdated_master/pco/advertisement/">Click Here</a><br/><br/>

 

Please View all relevant information at your earliest possible convenience.<br/><br/>
...
$sql ="INSERT INTO loginforads (country, city,name,designation,email,password) VALUES ('$country', '$city', '$name', '$designation', '$email', '$password')";
...
<h2 style='margin-top:-50px;' align='center'>Register Advertisement Provider</h2>
<br/><br/>
...
if ($resultt->num_rows > 0) {
  ...
  <div class='container'>
    ...
    <label>Send Access To</label>
     ...
     <input type="text" class="form-control" name='contactto' placeholder="Contact Person">
...
listhotels.innerHTML='';
 ...
 $.ajax({
              type:'POST',
              url:'gethotelsbycityfromcontacts.php',
...
$.ajax({
              type:'POST',
              url:'getdesignationofcontact.php',
              data:{'fullname':fullname,'name':name,'country':country,'city':city},
...
$.ajax({
 ...
 $.ajax({
              type:'POST',
              url:'validatehotelsregistered.php',
                    ...
                    if(result.includes('exists'))
             {
                Swal.fire({
  title: 'Error!',
  text: 'Hotel Already Registered in this Country and City!',
  icon: 'error',
  confirmButtonText: 'OK'
})
