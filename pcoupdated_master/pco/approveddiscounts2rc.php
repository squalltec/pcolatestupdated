 ...
 ?>
  ...
  <link href="assets/css/header-colors.css" rel="stylesheet" />
			...
			<form action='#' method='POST'>
				...
				<h6 style='margin-top:-100px;' class="mb-0 text-uppercase">Approved Discounts of <?php echo $hotel;?></h6>
				<hr/>
						...
						<div class="table-responsive">
							<table id="example2" class="table table-striped table-bordered">
								...
								<tbody>
								   ...
								   <?php
								   $an=0;
$sql ="SELECT * FROM newrentacarpricesdis WHERE name='$hotel' && country='$country' && city='$city' && approvedornot='approved'";
		$result = $conn->query($sql);
