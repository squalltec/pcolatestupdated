...
foreach($html223->find('div[class=gl-search-result_list]') as $cts){
			...
			//echo $attractions;
			 ...
			 $return_arr = array("capital" => $cap,"largest" => $largest,"officiallanguage" => $officiallanguage,"commonlanguage" => $comlang,"currency" => $currency,"callercode" => $callercode,"demonym" => $demon,"drivingside" => $drivingside,"iso" => $iso,"about" => $about,"airports"=>$airports_string,"attractions"=>$attractions,"cities"=>$citiesstring);
