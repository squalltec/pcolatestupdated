...
<div class="row">
              <div class="col col-lg-9 mx-auto">
                ...
                <div class="card radius-10">
                  <div class="card-body">
                    <h5 class="card-title">Transport Suppliers</h5>
...
?>
                     ...
                     <a href='vehicles2/redirecter.php?hotel=<?php echo $rowwa['name']?>&country=<?php echo $rowwa['country']?>&city=<?php echo $rowwa['city']?>'> <div class="accordion-item">
