...
Access System: <a href="https://squalltec.com/pcoupdated_master/pco/hotels/">Click Here</a><br/><br/>
...
if ($resultt->num_rows > 0) {
  ...
  while($roww = $resultt->fetch_assoc()) {
    ...
    <input type="text" list='listhotels' class="form-control" name='name' id='name' placeholder="Hotel Name">
