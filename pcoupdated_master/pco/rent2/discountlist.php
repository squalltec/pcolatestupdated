...
<h2 style='margin-top:-50px;' align='center'>Select Vehicle</h2>
...
$sqll ="SELECT * FROM newrentacarprices WHERE name='$hotel' && country='$country' && city='$city' GROUP BY brand";
...
$sqllz ="SELECT * FROM newrentacarprices WHERE name='$hotel' && country='$country' && city='$city' && brand='$bra' GROUP BY model";
...
$sqllzz ="SELECT * FROM newrentacarprices WHERE name='$hotel' && country='$country' && city='$city' && brand='$bra' && model='$mdo' GROUP BY year";
...
if ($resulttzz->num_rows > 0) {
  ...
  while($rowwzz = $resulttzz->fetch_assoc()) {
	...
	?>
      ...
      <a href='distveh.php?id=<?php echo $rowwzz['id']?>'>                    
