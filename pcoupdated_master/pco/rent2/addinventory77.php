...
$sql1 ="SELECT * FROM rentacarfeatures WHERE name='$value'";
...
$sqlbb="INSERT INTO rentacarfeatures (name) VALUES ('$value')";
...
$sqlo ="UPDATE rentacarInventorydatabase SET features='$inroomfacilities' WHERE hotel='$hotel' && country='$country' && city='$city' && brand='$brandd' && model='$roomtype'";
...
<h2 style='' align='center'>Features</h2>
