...
$cancellationpolicy=mysqli_real_escape_string($conn, $_POST['cancellationpolicy']);
    ...
    $checker2=$_POST['checkerdes2'];
    
    $dropoffterms=$_POST['dropoffterms'];
...
if($checker2=='on'){
        $_SESSION['dropoffterms']=$dropoffterms;
    }
    else{
        $_SESSION['dropoffterms']='';
    }
...
$sql = "UPDATE rentacarInventorydatabase SET cancellationpolicy='$cancellationpolicy', dropoffterms='$dropoffterms' WHERE hotel='$hotel' && country='$country' && city='$city' && brand='$brandd' && model='$roomtype'";
...
<br/>
    ...
    <div class="col-sm">
      ...
      <div class='row'>
    <div class="col-sm">
         <label>Terms & Conditions for Car Drop Off</label>
        <textarea class='form-control' required name='dropoffterms' placeholder='Terms & Conditions for Car Drop Off'><?php echo  $_SESSION['dropoffterms'];?></textarea>
         <label for='abc'>Same Terms & Conditions for All Cars?</label>
        <input type='checkbox' name='checkerdes2' id='abc2'>
