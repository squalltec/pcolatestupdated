...
if (isset($_POST['delme'])) {
	...
	$sql = "DELETE FROM rentusers WHERE id='$aidii'";
...
if (isset($_POST['submit'])) {
	...
	foreach ($fname as $value) {
		...
		$sql = "INSERT INTO rentusers (hotel,country,city,fname,lname,designation,department,phone,nationality,birthday,role,email,password)
           VALUES ('$hotel','$country','$city','$fname[$nn]','$lname[$nn]','$designation[$nn]','$department[$nn]','$phone[$nn]','$nationality[$nn]','$birthday[$nn]','$role','$email[$nn]','$password[$nn]')";
		...
		<div class="table-responsive mt-3">
			<table class="table align-middle" style="border: 1px solid #ce3435;">
				...
				<tbody>
					...
					$sql = "SELECT * FROM rentusers WHERE hotel='$han' && country='$can' && city='$ctan'";
