  ...
  <div class="ps-3">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb mb-0 p-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">Specify Regions</li>
      </ol>
    </nav>
  </div>
  <div class="ms-auto">
...
<form action="#" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
      ...
      <div class='row'>
        <div class='col-sm'>
          ...
          <input name='company' readonly value='<?php echo $hotel; ?>' class='form-control'>
      ...
      <div class="table-responsive">
        <table id="example2" class="table table-striped table-bordered">
          ...
          <tbody>
            ...
            $sql = "SELECT * FROM regionspecified WHERE company='$hotel'";
            $result = $conn->query($sql);
            ...
            ?>
                ...
                <tr>
                  <form action='#' method='POST'>
                    ...
                    <td><input type='submit' name='update' class='btn btn-success me-2' value='Update'><input type='submit' name='delete' class='btn btn-danger' value='Delete'></td>
  ...
  <button style="float:right;" type="submit" name='submit' class="btn btn-danger col-md-2">Submit</button>
