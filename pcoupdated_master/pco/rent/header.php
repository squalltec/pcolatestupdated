    ...
    if (event.which == '13') {
      event.preventDefault();
       ...
       <div class="switcher-body">
        <button style='top:80px;' class="btn btn-danger btn-switcher shadow-sm" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling"><i class="bi bi-paint-bucket me-0"></i></button>
