...
$arrivalcar=$_SESSION['acar'];
$departurecar=$_SESSION['dcar'];
...
$arrivalvehicle=$_SESSION['arrivalvehicle'];
	...
	$ttitle=$_SESSION['cctitle'];
	$ffname=$_SESSION['ccfname'];
	$llname=$_SESSION['cclname'];
	$pphone=$_SESSION['ccphone'];
	$eemail=$_SESSION['ccemail'];
...
if ($resulte === TRUE) {
   ...
   $chkflw= $_SESSION['checkflow'];
	if($chkflw=='yes'){
	    header("Location: confirmation_all.php");
	}
	else{
                              ...
                              <table width="95%" cellspacing="0" cellpadding="4" border="1" class="list_hotels cust_tb" style="background:#fff; margin:18px;">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <th align="center" class="nocurve">QTY</th>
                                    <th align="center" class="nocurve">AVG/KM</th>
                                    <th align="right" class="rcurve">TOTAL AED</th>
                                  </tr>
                                  
                                  <tr>
                                    <td width="85%" align="left"><b><?php echo $triptype;?></b><br>
                                     <?php  if($arrivaldate!='') {?>
                                       <?php echo $airportname;?> - <?php echo $arrivalairline;?><br>
                                      Date:: <?php echo $arrivaldate; ?>&nbsp;&nbsp;Car: <?php 
...
echo $airportname;?> - <?php echo $departureairline;?><br>
                                      Date:: <?php echo $departuredate; ?>&nbsp;&nbsp;Car: <?php 
                                      
                                       $aaidd=$departurecar;
                                       $sqlra ="SELECT * FROM vehicles WHERE id='$aaidd'";
		$resultra = $conn->query($sqlra);
