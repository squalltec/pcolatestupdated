...
<?php include_once("includes/header.php"); ?>
    ...
    <div class="container_16">
        ...
        <fieldset>
            <div class="grid_16">
            <h4 class="float-left" style="padding:10px 20px; border:3px solid #090; color:#090; font-weight:bold; margin-bottom:10px;">Thank you. Your booking is now confirmed.</h4>
            ...
            <table align='center' width="100%" class="confirmation-table">
                  ...
                  <tr>
            	    <td class="color-1 grid_5"><a href='flights.php'><h2 class='color-1'><b>Want Transport?</b></h2></a></td>
		   ...
		   <div class="grid_16">
            ...
            <p><strong>We wish you a pleasant stay</strong><br>
