...
<?php include_once("includes/header.php"); ?>
    ...
    <div class="container_16">
        ...
        <fieldset>
            <div class="grid_16">
            <h4 class="float-left" style="padding:10px 20px; border:3px solid #090; color:#090; font-weight:bold; margin-bottom:10px;">Thank you. Your Transport booking is now confirmed.</h4>
		   ...
		   <div class="grid_16">
            ...
            <p><strong>We wish you a pleasant journey</strong><br>
