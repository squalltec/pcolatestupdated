  ...
  while($rowwsa = $resulttsa->fetch_assoc()) {
	  ...
	  if($max0<=(int)$rowwsa['max'] && $max1<=(int)$rowwsa['max'] && $max2<=(int)$rowwsa['max'] && $max3<=(int)$rowwsa['max'] && $max4<=(int)$rowwsa['max'] && $max5<=(int)$rowwsa['max'] && $max6<=(int)$rowwsa['max'] && $max7<=(int)$rowwsa['max'] && $max8<=(int)$rowwsa['max'] && $max9<=(int)$rowwsa['max'])
	  {
		 ...
		 ?>
		    ...
		    <li>
        <div style='max-height:150px;' class="results-container clearfix">
		   


		<div class="results-inside">
            <h3 class="color-1"><?php echo $roww['name']; ?><p style='color:green;'><b style='font-size:2em;'>.</b>&nbsp;Available</p></h3> 
            <hr />
            <p class="address"><?php echo $roww['location']; ?></p>
			
            <p class="description"><?php echo $roww['description']; ?></p>
        
               <p class="description"><?php echo $roww['mealplan']; ?></p>
          ...
          <div style='margin-top:-30px;' class="results-rate" align="center">
           <h3 class="color-1">Terms & Conditions</h3>
           <br/>
           <img style='width:30px;' src='person.png'>  <img style='width:30px;' src='child.png'>  <img style='width:30px;' src='cancel.png'>
            ...
            <h3 class="color-1">AED <?php echo $pri[$i];?></h3>
