                            ...
                            <form class='row notranslate' method="POST" action='#'>
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 mb-lg-0 pe-0">
                                        ...
                                        <input id="roomnumberschange" style="color:lightgray;" name='roomnumberschange' value='<?php
                                                                                                        if ($gsendroomnumbers == '') {
                                                                                                            echo '0';
                                                                                                        } else {
                                ...
                                <div class="card-header filterCardHead " id="priceRangeOne" >
                                    <h5 class="mb-0">
                                        <span class="btn btn-link FilterTabLink" >
                                            Price Range <small>(Per Night)</small>
                                        </span>
                                    </h5>
                                </div>
                                                                ...
                                                                ?>
                                                                    <div class='row d-flex content2 ' style="margin-bottom:10px; ">
                                                                        <div class='col-lg-4 col-md-8 col-sm-8 order-1 order-md-0 order-lg-0  p-0'>
                                                                            ...
                                                                            <div style=' margin:0 auto;  position:relative' class="room_box_img">
...
</html>in.js" integrity="sha384-IQsoLXl5PILFhosVNubq5LC7Qb9DXgDA9i+tQ8Zj3iwWAwPtgFTxbJ8NT4GN1R8p" crossorigin="anonymous"></script> -->
