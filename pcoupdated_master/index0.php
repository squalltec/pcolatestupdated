                    ...
                    <div class='roundme row' style="width: 100%;">
                        ...
                        <div style='color:#828282; margin-top:20px; padding:20px;' class='notranslate  input-iconszz roundme2 '>
                            ...
                            <div class='row'>
                                ...
                                <div style='text-align:center;' class='col-sm'>
                                    <!-- <label >Nights</label>-->
                                    <i style='opacity:50%; margin-left:40px; padding-top:5px; ' class="stylenotneeded ">Nights</i>
                            ...
                            <div class='row'>
                                ...
                                <div class="col-12 text-center">
                                    ...
                                    <input type='submit' name='submit' style='float:right;' class="btn btnba btn-primary btn-lg border-0 " value='Search Hotel'>
                                </div>
                            </div>
  ...
  -->
    ...
    -->
        ...
        <div style='text-align:center;' class="jumbotron">
            ...
            <p class="lead">
                <a class="btn btn-primary btn-lg " href="#subme" style='font-size:1.4vh;' role="button">Subscribe Now</a>
            </p>
        </div>
