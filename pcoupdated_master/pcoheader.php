...
function changeLanguage(lang) {
  ...
  <!--GOOGLE TRANSLATE-->
    ...
    <h6  style='font-weight:100 !important; color:white; margin-right:20px; margin-top:16px;   float:right; font-size:2vh; '><a id='ach' href="retrieve.php">My Booking </a>| <nonsense data-toggle="modal" data-target="#exampleModalCenter3" >Agent Login | VIP Login</nonsense></h6> 
    ...
    <img style=' width:20%;' src='downbtn.png'>
