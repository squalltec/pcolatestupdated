...
if (isset($_POST['submit'])) {
    ...
    echo "<script>location.replace('rentacarandhotelinvoice.php');</script>"; 
  } else {
                                                ...
                                                <div class="col-md-12 mb-2">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <input type="text" name="fname" value='<?php echo  $_SESSION['fname'][0];?>' placeholder="First Name" class="form-control" />
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <input type="text" name="lname" value='<?php echo  $_SESSION['lname'][0];?>'placeholder="Last Name" class="form-control" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-2">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-12" style="padding: 0px;">
                                                            <input type="text" name="phone" value='<?php echo  $_SESSION['phone'][0];?>'placeholder="Phone" class="form-control" />
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <input type="text" name="email" value='<?php echo  $_SESSION['email'][0];?>' placeholder="Email" class="form-control" />
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                                            <input type="text" name="nationality" placeholder="Nationality" value='<?php echo  $_SESSION['nationality'][0];?>' class="form-control" />
                                                        </div>
