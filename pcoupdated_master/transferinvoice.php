            ...
            <div class="cs-invoice_in" id="download_section">
                ...
                <div class="cs-table cs-style1">
                    <div class="cs-round_border">
                        <div class="cs-table_responsive">
                            <div class="d-block invoice-tbl-item-title primary_bold">
                                <table>
                                    <thead>
                                        <tr>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr class="cs-border_left">
                                                ...
                                                <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right"><b class="primary_bold">AED </b><?php echo $totalpricewithvat; ?></td>
                                            </tr>
                                            <tr class="cs-border_left">
                ...
                <div class="cs-invoice_btns cs-hide_print">
                            <div class="row" style="width: 100%;">
                                ...
                                <div class="col-md-6">
                                    <form action='transferbookingconfirmed.php' method='POST'>
