...
$sql = "INSERT INTO rentacarbookings (title,fname,lname,email,phone,nationality,carid,pickuplocation,pickupdate,pickuptime,dropofflocation,dropofftime,dropoffdate,days,price,uniquenumber,remarks,pickordelivery,flightnumb1,flightnumb2)
           VALUES ('$title','$fname','$lname','$email','$phone','$nationality','$aid','$pickuplocation','$pickupdate','$pickuptime','$dropofflocation','$dropofftime','$dropoffdate','$totaldays','$totalpricewithvat','$uniquenumber','$remarks','$pickordelivery','$flightnumb1','$flightnumb2')";
