...
$sqllads = "SELECT * FROM adscompany WHERE country='All World'";
$resulttads = $conn->query($sqllads);


if ($resulttads->num_rows > 0) {
    // output data of each row
    while ($rowwads = $resulttads->fetch_assoc()) {
        array_push($adposition, $rowwads['position']);
        array_push($adimage, $rowwads['image']);
        array_push($adcompany, $rowwads['name']);
        array_push($adexception, $rowwads['exceptcountries']);
        array_push($adlink, $rowwads['link']);
    }
    ...
    foreach ($adexception as $aa) {

        $bq = explode(',', $aa);

        foreach ($bq as $nn) {

            if ($nn == $countrytocheck) {
                $checkde = true;
            }
        }
    }
    ...
    if ($checkde == true) {
        ...
        $sqllads = "SELECT * FROM adscompany WHERE country='$countrytocheck'";
        $resulttads = $conn->query($sqllads);
...
<body>
    ...
    <div class="main-holder">
        ...
        <div id="changehead" style=' margin-top:-20px; width:100%; background-color:#dc3545; background-image: linear-gradient(45deg, #dc3545 0%, black 100%);'>
            <div class="topBar">
                ...
                <h6 class="topBarBigScreen" style='font-weight:100 !important; color:white; margin-right:20px; margin-top:16px;   float:right; font-size:2vh; '>
                    <a id='ach' href="retrieve.php">My Booking </a>| <nonsense data-toggle="modal" data-target="#exampleModalCenter3signup"> Register | </nonsense>
                    <nonsense data-toggle="modal" data-target="#exampleModalCenter3signup">Login </nonsense>
                </h6>
                ...
                <div class="container">
                    ...
                    <div style='position: relative; z-index:2;' class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mx-auto mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/become-partner.php">Become a Partner</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <span class="mobileviewMenuItems">
                                <li class="nav-item">
                                    <a class="nav-link" id='ach' style="color:rgba(0,0,0,.55)" href="retrieve.php">My Booking </a>
                                </li>
                                <li class="nav-item">
                                    <nonsense class="nav-link" data-toggle="modal" data-target="#exampleModalCenter3">Agent Login </nonsense>
                                </li>
                                <li class="nav-item">
                                    <nonsense class="nav-link" data-toggle="modal" data-target="#exampleModalCenter3">VIP Login</nonsense>
                                </li>
                            </span>
                        </ul>
        ...
        <form autocomplete='off' class='' action='#' method='POST'>
            ...
            <section style=' margin-top:-1px; margin-bottom:-560px;' class='notranslate  banner'>
                ...
                <div class="container">
                    ...
                    <div style='z-index:2;' class="inner_content">
            ...
            <div class="container-fluid" style="z-index: 1;">
                ...
                <div id='hdm1' class="adban adh typewriter centered" style="z-index:1; padding-bottom: 5%;">
                    <h1 class='hideMe2' style='text-shadow: 2px 2px 2px black !important; align:left; font-family:inter,sans-serif; font-size:8vw; text-shadow: 2px 2px 2px black !important;'>Life is an event.</h1>

                </div>

                <div id='hdm2' class="adban adh typewriter2 centered" style="z-index:1;">
                    <br /> <br /> <br /> <br /> <br /> <br /> <br />
                    <h1 id='hideMe' class='hideMe' style='text-shadow: 2px 2px 2px black !important; text-shadow: 2px 2px 2px black !important;margin-left:200px; font-family: inter,sans-serif; font-size:8vw;'> Make it Memorable.</h1>
                </div>
            ...
            <section style='display:block; padding:0; margin:0; height:80%;' class=" container-fluid adban banner" id='vidbanner'>
                ...
                <div style="width:100%;height:0px;position:relative;padding-bottom:36.364%;" id="abvideo">
                    <iframe src="https://streamable.com/e/3oifki?autoplay=1&nocontrols=1" id="video1" frameborder="0" width="100%" height="100%" allowfullscreen allow="autoplay" style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden; "></iframe>
                </div>
                ...
                <script>
                    ...
                    function PlayVideo() {
                        ...
                        document.getElementById('play-background').click();
                    }
            ...
            <!--checking Slider-->
            <!-- <label onclick="PlayVideo()">Video Play</label> -->
            ...
            <section style='margin-top:75px; margin-bottom:-100px;' class='nomm'>
                <div class='container formContainer'>
                    <div class='roundme row' style="width: 100%; padding:0px;">
                        <div style="padding: 0px;">
                                ...
                                <div class="row col-md-12   ">
                                    <div class="col-md-3">
                                        <div class="row" style="margin-bottom: -10px;">
                                            <span class="menu__item active" id="manuItem1" data-UrlPath="/index.php" style="--bgColorItem: #fff;">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="30" height="30" fill="#ce3435">
                                    ...
                                    <div class="col-md-3">
                                        <div class="row" style="margin-bottom: -10px;">
                                            <span class="menu__item" id="manuItem2" data-UrlPath="/venues.php" style="--bgColorItem: #fff;">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="30" height="30" fill="#fff">
                                                    <!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            ...
                            <script>
                                ...
                                function clickItem(item, index) {
                                    ...
                                    $('#manuItem1').children().attr('fill', cola);
                                    $('#manuItem2').children().attr('fill', cola);
                                    $('#manuItem3').children().attr('fill', cola);
                                    $('#manuItem4').children().attr('fill', cola);

                                    $('#' + item.id).children().attr('fill', colora);
                        ...
                        <div style='color:#828282; margin-top:10px; padding:0px 20px 15px 20px;  border-radius: 0px 0px 25px 25px;' class='notranslate  input-iconszz roundme2 '>
                            ...
                            <div class='row'>
                                ...
                                <div style='text-align:center;' class='col-sm'>
                                    ...
                                    <input id='datessy' style='text-align:center;' class='form-control' type="text" placeholder='Check In - Check Out' name="datefilter" value="" />
                                    ...
                                    <script type="text/javascript">
                                        $(function() {
                                            ...
                                            $('input[name="datefilter"]').on('apply.daterangepicker', function(ev, picker) {
                                                ...
                                                document.getElementById('sdate').value = picker.startDate.format('YYYY-MM-DD');
                                                document.getElementById('edate').value = picker.endDate.format('YYYY-MM-DD');
                                ...
                                <div style='text-align:center;' class='col-sm'>
                                    <!-- <label >Nights</label>-->
                                    <!-- <i style='opacity:50%; margin-left:40px; padding-top:5px; ' class="stylenotneeded "> -->
                                    <!-- <p style="margin-left:40px; padding-top:5px; ">Nights</p> -->
                                    <!-- </i> -->
  ...
  -->
        ...
        <div class="modal fade" id="exampleModalCenterreward" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" style="height: auto; max-height: 100% !important;">
                    ...
                    <div style='margin:0 auto;' class="notranslate modal-body">
                        ...
                        <div class='container'>
                            ...
                            <div class='row '>
                                <div class='col-lg-6 col-md-6 col-sm-12 p-1'><label>Company Name</label><input required name='company' id='company' class='form-control' placeholder='Company Name'></div>
                                <div class='col-lg-6 col-md-6 col-sm-12 p-1'><label>Designation</label><input required name='designation' id='designation' class='form-control' placeholder='Designation'></div>
                            </div>
                            <div class='row '>
                                <div class='col-lg-6 col-md-6 col-sm-6 p-1'><label>First Name</label><input required name='fname' id='fname' class='form-control' placeholder='First Name'></div>
                                <div class='col-lg-6 col-md-6 col-sm-6 p-1'><label>Last Name</label><input required name='lname' id='lname' class='form-control' placeholder='Last Name'></div>
                            </div>
                            <div class='row '>
                                <div class='col-lg-12 col-md-12 col-sm-12 p-1'><label>Phone</label><input required name='phone' id='phone' class='form-control' placeholder='Phone'></div>
                            </div>

                            <div class='row '>
                                <div class='col-lg-6 col-md-6 col-sm-12 p-1'><label>Email</label><input required name='email' id='email' type='email' class='form-control' placeholder='Email'></div>

                                <div class='col-lg-6 col-md-6 col-sm-12 p-1'><label>Password</label><input required type='password' name='password' id='password' class='form-control' placeholder='Password'></div>
                            </div>

                            <div class='row '>
                                <div class='col-lg-6 col-md-6 col-sm-12 p-1'><label>Nationality</label><input required name='nationality' id='nationality' class='form-control' placeholder='Nationality'></div>
                                <div class='col-lg-6 col-md-6 col-sm-12 p-1'><label>Date of Birth</label><input required type='date' id='dateofbirth' name='dateofbirth' class='form-control'></div>
                            </div>

                            <div class='row '>

                                <div class='col-lg-12 col-md-12 col-sm-12 p-1'><label>Company Logo</label><input id='logo' required type='file' name='logo' class='form-control'></div>
                            </div>
        ...
        <div class="modal fade" id="exampleModalCenter3signup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class=" modal-dialog modal-lg modal-content" style="width:600px; overflow:hidden; height: 90%;" role="document">
    ...
    -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 ">
                    ...
                    <a style="cursor: pointer;" data-side='left' onclick='adclicked(this);'>

                        <?php
                        if (in_array("Both", $adposition)) {

                            $idasd = array_search("Both", $adposition);


                            echo "<img src='pco/ads/" . $adcompany[$idasd] . "/" . $adimage[$idasd] . "'>";

                            echo "<input style='display:none;' id='adcompanyleft' value='" . $adcompany[$idasd] . "'>";

                            echo "<input style='display:none;' id='adlinkleft' value='" . $adlink[$idasd] . "'>";
                        }




                        if (in_array("Left", $adposition)) {

                            $idasd = array_search("Left", $adposition);
                    ...
                    <input style='display:none;' id='countryloggedfrom' value='<?php echo $countrytocheck; ?>'>
                </div>
                <div class="col-md-8" style="padding-top: 5%;">
                    <div style='text-align:center;' class="jumbotron">
                        ...
                        <p class="lead">
                            <a class="btn btn-lg btnba" id="subr0" href="#subme" style="background: linear-gradient(45deg, #dc3545 0%, black 100%); font-size: 2.4vh;color: white;" role="button">Subscribe Now</a>
                        </p>
                ...
                <div class="col-md-2 text-right ">
                    ...
                    <a style="cursor: pointer;" data-side='right' onclick='adclicked(this);'>
                        <?php
                        if (in_array("Both", $adposition)) {
                            ...
                            echo "<img style='float: right;' src='pco/ads/" . $adcompany[$idasd] . "/" . $adimage[$idasd] . "'>";
                            echo "<input style='display:none;' id='adcompanyright' value='" . $adcompany[$idasd] . "'>";
                            echo "<input style='display:none;' id='adlinkright' value='" . $adlink[$idasd] . "'>";
                        }




                        if (in_array("Right", $adposition)) {

                            $idasd = array_search("Right", $adposition);
        ...
        <script>
            function adclicked($this) {


                var side = $this.getAttribute('data-side');
                var con = document.getElementById('countryloggedfrom').value;

                var abc = '';
                var link = '';

                if (side == 'left') {
                    abc = document.getElementById('adcompanyleft').value;
                    link = document.getElementById('adlinkleft').value;

                }
                if (side == 'right') {
                    abc = document.getElementById('adcompanyright').value;
                    link = document.getElementById('adlinkright').value;
        ...
        <section>
            ...
            <input id='colora' value='#CE3435' style='display:none;'>
            ...
            if (event == 'Select Event') {
                ...
                $(document).ready(function() {
                    $("footer").hover(function() {
                        $(this).css("border-top", "1px solid #dc3545");
                    }, function() {
                        $(this).css("border", "");
                    });
                });
                ...
                */
                ...
                subr0.setAttribute('style', 'font-size:2.4vh; color:white; background: linear-gradient(45deg, #dc3545 0%, black 100%) !important;');
                ...
                document.getElementsByTagName('html')[0].style.setProperty('--bgColorMenu', '#dc3545');
                ...
                document.getElementById('colora').value = '#dc3545';
                if (colora == '#FFFFFF' || colora == 'white') {
                    colora = 'black';
                } else {
                ...
                $('#manuItem1').children().attr('fill', '#dc3545');
...

                {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            $(document).ready(function() {
                                $(".single-service").hover(function() {
                                    $(this).css("border", "1px solid " + result.backcolor);
                                }, function() {
                                    $(this).css("border", "");
                                });
                            });
                            ...
                            $(document).ready(function() {
                                $(".card").hover(function() {
                                    $(this).css("border", "2px solid " + result.backcolor);
                                }, function() {
                                    $(this).css("border", "");
                                });
                            });
                            ...
                            $(document).ready(function() {
                                $("footer").hover(function() {
                                    $(this).css("border-top", "1px solid " + result.backcolor);
                                }, function() {
                                    $(this).css("border", "");
                                });
                            });
                            ...
                            */
                            ...
                            subr0.setAttribute('style', 'font-size:2.4vh; color:' + result.color + '; background: linear-gradient(45deg,' + result.backcolor + ' 0%, black 100%) !important;');
                            ...
                            if (result.backcolorr == '#FFFFFF' || result.backcolor == 'white') {
                                document.getElementsByTagName('html')[0].style.setProperty('--bgColorMenu', 'black');
                            } else {
                                document.getElementsByTagName('html')[0].style.setProperty('--bgColorMenu', result.backcolor);

                            }

                            document.getElementById('colora').value = result.backcolor;


                            backcolor = result.backcolor
                            cola = '';
                            if (backcolor == '#FFFFFF' || backcolor == 'white') {
                                backcolor = 'black';
                                cola = 'grey';
                            } else {
                            ...
                            $('#manuItem1').children().attr('fill', backcolor);
                            $('#manuItem2').children().attr('fill', cola);
                            $('#manuItem3').children().attr('fill', cola);
                            $('#manuItem4').children().attr('fill', cola);
...
*/
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            ...
                            if (result.backcolor == '#FFFFFF' || result.backcolor == 'white') {
                                document.getElementsByTagName('html')[0].style.setProperty('--bgColorMenu', 'black');
                            } else {
                                document.getElementsByTagName('html')[0].style.setProperty('--bgColorMenu', result.backcolor);
