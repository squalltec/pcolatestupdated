                        ...
                        <div class="cs-round_border">
                            <div class="cs-table_responsive">
                                <div class="invoice-tbl-item">
                                    <div class="d-block invoice-tbl-item-title px-4">Hotel: <?php echo $hotel; ?>
                                    </div>
                                    <table>
                                        <thead>
                                            <tr>
                                ...
                                <div class="cs-invoice_footer cs-border_top">
                                    <div class="cs-left_footer cs-mobile_hide">
                                        <p class="cs-mb0"><b class="cs-primary_color">In Word:</b></p>
                                        <p class="cs-m0">
                                        <div class="invoice-tbl-f">
                                            <?php echo numberTowords("$totalamount"); ?>
                                            <div class="fw-bold">VAT: <?php
                                                                        echo 'AED ' . round(((intval($totalamount) / 100) * 5), 0);
                                                                        ?>
                                                <br /> Grand Total: <?php echo 'AED ' . $totalamount; ?>
                                            </div>
                                        </div>
                                        <?php
                                        if ($tax == '5%') {
