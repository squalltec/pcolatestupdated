...
{
    $_SESSION['noofadults']=$_POST['noofadults'];
    $_SESSION['noofchildrens']=$_POST['noofchildrens'];
...
$sql2 = "SELECT * FROM meetingbanquetplanner WHERE id='$venueid'";
...
<section class="tabs-section text-white">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 p-0" >
                                <div class="panel-group" id="accordion">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="roomColl1" class="panel-collapse show collapse in">
 ...
 <input type='submit' style='float:right;' class='btn btn-danger' value='Book'>
                                            </div>
                                        </div>
                                    </div>
