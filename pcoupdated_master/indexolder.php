    ...
    <div class="main-holder">
        ...
        <div id="changehead" style=' margin-top:-20px; width:100%; background-color:#dc3545; background-image: linear-gradient(45deg, #dc3545 0%, black 100%);'>
            <div class="topBar">
                ...
                <h6 class="topBarBigScreen" style='font-weight:100 !important; color:white; margin-right:20px; margin-top:16px;   float:right; font-size:2vh; '><a id='ach' href="retrieve.php">My Booking </a>| <nonsense data-toggle="modal" data-target="#exampleModalCenter3signup"> Register | </nonsense> <nonsense data-toggle="modal" data-target="#exampleModalCenterreward">Agent Login </nonsense>|<nonsense data-toggle="modal" data-target="#exampleModalCenter3"> VIP Login</nonsense>
                </h6>
            ...
            <section style=' margin-top:-1px; margin-bottom:-560px;' class='notranslate  banner'>
                ...
                <div class="container">
                    ...
                    <div style='z-index:2;' class="inner_content">
                        ...
                        <div class='form' style="width: 950px;">
...
var date = currentdate.getDate() + "/"
          ...
          var time = currentdate.getHours() + ":"  
                ...
                url: 'adview.php',
                data: {
                    'country': con, 'side':side,'company':abc,'datee':date,'timee':time
                },
