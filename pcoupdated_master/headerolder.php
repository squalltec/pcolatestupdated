...
<body>
  ...
  <div class="main-holder">
    <div style=' margin-top:-20px; width:100%; background-color:#dc3545; background-image: linear-gradient(45deg, #dc3545 0%, black 100%);'>
      <div class="topBar">
        ...
        <h6 class="topBarBigScreen" style='font-weight:100 !important; color:white; margin-right:20px; margin-top:16px;   float:right; font-size:2vh; '><a id='ach' href="retrieve.php">My Booking |</a>
          <nonsense data-toggle="modal" data-target="#exampleModalCenter3signup">Register | </nonsense>
          <nonsense data-toggle="modal" data-target="#exampleModalCenter3signup">Agent Login | VIP Login</nonsense>
        </h6>
