                ...
                <div class="cs-invoice_in" id="download_section">
                    <div class="cs-invoice_head cs-type1 cs-mb25">
                        <div class="cs-invoice_left">
                            <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color primary_bold">Invoice No:</b> <?php echo $uniquenumber; ?></p>
                            <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color primary_bold">Date: </b><?php echo date("d/m/Y"); ?></p>
                        </div>
                    ...
                    <div class="cs-invoice_head cs-mb10">
                        <div class="cs-invoice_left">
                            <b class="cs-primary_color primary_bold">Invoice To:</b>
                            <p class="font_13px">
                        ...
                        <div class="cs-invoice_right cs-text_right">
                            <b class="cs-primary_color primary_bold">Pay To:</b>
                            <p class="font_13px">
                                Biman Airlines <br>
                        ...
                        <div class="cs-round_border">
                            ...
                            <div class="d-block invoice-tbl-item-title">Hotel: <?php  ?>
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Particulars</th>
                                            <th class="cs-width_4 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Check In</th>
                                            <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Check Out</th>
                                            <th class="cs-width_1 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Nights</th>
                                            <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Avg/Night</th>
                                            <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold cs-text_right">Total AED</th>
                                        </tr>
                                    </thead>
                            ...
                            <div class="cs-invoice_footer cs-border_top">
                                <div class="cs-left_footer cs-mobile_hide">
                                    <p class="cs-mb0"><b class="cs-primary_color primary_bold">In Word:</b> <?php echo numberTowords("$totalamount"); ?></p>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr class="cs-border_left">
                                                <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Grand Total</td>
                                                <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right"><?php echo 'AED ' . $totalpricewithvat; ?></td>
                                            </tr>
                                            <tr class="cs-border_left">
                                                <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Vat</td>
                    ...
                    <div class="cs-table cs-style1">
                        ...
                        <div class="cs-round_border">
                            <div class="cs-table_responsive">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Particulars</th>
                                            <th class="cs-width_4 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Pickup Location/Date/Time</th>
                                            <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Dropoff Location/Date/Time</th>
                                            <th class="cs-width_1 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Days</th>
                                            <th class="cs-width_1 cs-semi_bold cs-primary_color cs-focus_bg primary_bold">Avg/Day</th>
                                            <th class="cs-width_2 cs-semi_bold cs-primary_color cs-focus_bg primary_bold cs-text_right">Total AED</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div class="cs-invoice_footer cs-border_top">
                                <div class="cs-left_footer cs-mobile_hide">
                                    <p class="cs-mb0"><b class="cs-primary_color primary_bold">In Word:</b><?php echo numberTowords("$totalpricewithvat"); ?></p>
                                </div>
                                <div class="cs-right_footer">
                                    <table>
                                        <tbody>
