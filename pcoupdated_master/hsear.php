...
if($roomsrecieved=='0'|| $roomsrecieved=='' || $roomsrecieved==0)
{
    $_SESSION['sendroomnumbers']='1';
    $roomsrecieved='1';
}
        ...
        if ($resultrooms2->num_rows > 0) {
            ...
            while ($rowrooms2 = $resultrooms2->fetch_assoc()) {
                ...
                if ($countrums2 > 0) {
                    ...
                    array_push($allavailroomnumbers,$countrums2);
                    ...
                    if ($approvedprices2 == true) {
                        ...
                        if ($biggest <= $addme2) {
                            ...
                            if (empty($rowrooms2['roomsize'])) {
                                array_push($roomsizesnew, array($hot . $rowrooms2['type'] => $rowrooms2['roomsizedouble']));
                            } else {
        ...
        if ($countrums > 0) {
            ...
            if ($approvedprices == true) {
                ...
                if ($biggest <= $addme) {
                    ...
                    if (empty($rowrooms['doubledescription'])) {
                        array_push($roomssingledescription, $rowrooms['singledescription']);
                    } else {
                        array_push($roomssingledescription, $rowrooms['doubledescription']);
                    }

                    if ($rowrooms['doubleadultoccupancy'] == '') {
                        array_push($adultsallowed, $rowrooms['singleadultoccupancy']);
                        array_push($childrenallowed, $rowrooms['singlechildoccupancy']);
                        array_push($extrabedsallowed, $rowrooms['singleextrabedsallowed']);
                    } else {
                    ...
                    if (empty($rowrooms['roomsize'])) {
                        array_push($roomsizes, array($ghotel . $rowrooms['type'] => $rowrooms['roomsizedouble']));
                    } else {
                        array_push($roomsizes, array($ghotel . $rowrooms['type'] => $rowrooms['roomsize']));
                    }
...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['aallowednew'] = $adultsallowednew;
    $_SESSION['callowednew'] = $childrenallowednew;
    $_SESSION['eballowednew'] = $extrabedsallowednew;
...
<head>
    ...
    <!--<div style='' class="se-pre-con"> <center><img loading="lazy" style='width:150px; margin-top:300px;' src='hotelloader.gif'></center> </div>-->
...
<body>
                ...
                <section class="page_searchbox" style="background:none; ">
                    <div class="container px-0" style="padding-right:24px !important;">
                        <div class="search_box" style="padding-left:0.8em;  box-shadow: 0px 15px 39px 0px rgb(165 9 25 / 40%) !important;">
                            ...
                            <form class='row notranslate' method="POST" action='#'>
                      ...
                      $sqllascheckhotel = "SELECT * FROM hotelsdatabase WHERE name='$ghotel'";  
                      
                          $resultcheckhotel = $conn->query($sqllascheckhotel);

                                            while ($rowcheckhotel = mysqli_fetch_assoc($resultcheckhotel)) {
                                               
                                                if($rowcheckhotel['star']==$gsendcategory || $gsendcategory=='All')
                                                {
                                                ?>
                               ...
                               if(($gsendcategory!='All' || $gsendcategory!='') && ($ln!='All'||$ln!=''))            
                                    {       
  ...
  if(($gsendcategory!='All' || $gsendcategory!='') && ($ln=='All'||$ln=='') )        
                     ...
                     $sqllas = "SELECT * FROM hotelsdatabase WHERE country='$cn' && star='$gsendcategory'";
}
 ...
 if(($gsendcategory=='All' || $gsendcategory=='') && ($ln!='All'||$ln!='') )        
                        ...
                        $sqllas = "SELECT * FROM hotelsdatabase WHERE country='$cn' && city='$ln'";
}
 ...
 if(($gsendcategory=='All' || $gsendcategory=='') && ($ln=='All' || $ln==''))        
                     ...
                     $sqllas = "SELECT * FROM hotelsdatabase WHERE country='$cn'";
}
                                    ...
                                    <div class="col-lg-3 col-md-8 col-sm-12 col-xs-12 mb-3 mb-lg-0  CalenderDiv" style="padding-left: 10px;">
                                        ...
                                        <div style='text-align:center;' class='col-sm calender'>
                                            ...
                                            <input id='datessy' style='text-align:center; color: lightgray !important;' class='notranslate form-select' type="text" value='<?php echo $sdate . "-" . $edate; ?>' placeholder='Check In - Check Out' name="datefilter" value="" />
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12 mb-lg-0 pe-0">
                                        ...
                                        <input id="roomnumberschange" style="height:49px; color:lightgray;" name='roomnumberschange' value='<?php
                                                                                                        if ($gsendroomnumbers == '') {
                                                                                                            echo '0';
                                                                                                        } else {
                                    ...
                                    <div class="col-lg-1 col-md-4 col-sm-12 col-xs-12 mb-3 mb-lg-0 pe-0 text-right  search_submit">
                                        ...
                                        <button type="submit" name='modify' class="btn btn-primary SBtn float-sm-rigth float-md-left"><i class="bi bi-search"></i></button>

                                        <button style='display:none;' id='clickmodify' class="btn btn-primary"><i class="bi bi-search"></i></button>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-12 col-xs-12" style="padding:0 !important; margin:0px;">
                        <div id="accordion">
                            <div class="card filterCard">
                                ...
                                <div id="popularFilters" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                            ...
                            <div class='row'>
                                <div>
                                    <div class="container p-0">
                                                ...
                                                <div class="item_details" style="border-right: 1px solid rgba(0, 0, 0, 0.3);  padding-top: 15px; padding-left:22px; padding-right:22px; min-width:32.3%;">
                                                    ...
                                                    <div class="room_galary">
                                                        ...
                                                        ?>
                                                            <a href="pco/Hotel Images/<?php echo $ghotel; ?>/<?php echo $images[$x]; ?>" data-lightbox="room_gal_<?php echo $gals; ?>">
                                                                <?php
                                                                if (file_exists('pco/Hotel Images/' . $ghotel . '/' . $images[$x])) {
                                                                ?>
                                                                    <img loading="lazy" src="pco/Hotel Images/<?php echo $ghotel; ?>/<?php echo $images[$x]; ?>" alt="" loading="lazy">
                                                                <?php
                                                                } else {
                                                                ?>
                                                    ...
                                                    <div class="row col-md-12" style="position:absolute; bottom:0;">
                                                        ...
                                                        <ul id="menu" style="padding:0px; ">
                                                            ...
                                                            <li><span class="btnNew"><i class="fa fa-home"></i> &nbsp;&nbsp;Restaurant&nbsp;&nbsp;</span></li>
                                                ...
                                                <form class='notranslate' action='#' method='POST' style="position:relative;     width: 100%;">
                                                    ...
                                                    <div class="row">
                                                        <div style='display:flex; border: none !important; padding-top:15px; padding-bottom:65px;' class="other_room_list">
                                                            <div style="min-width:100%; height:auto;" class="roomsList">
                                                                <?php
                                                                $xv = 1000;
                                                                $xvv = 3000;
                                                                $randrn = '';
                                                                ...
                                                                ?>
                                                                    <div class='row d-flex content2 ' style="margin-bottom:10px; ">
                                                                        <div class='col-lg-4 col-md-8 col-sm-8 order-1 order-md-0 order-lg-0  p-0'>
                                                                            ...
                                                                            <div style=' margin:0 auto;  ' class="room_box_img">
                                                                                <a href='#' data-bs-toggle="modal" data-bs-target=".roomamsModalSH<?php echo $x; ?>">
                                                                                    <?php
                                                                                    if (file_exists('pco/Room Uploads/' . $ghotel . '/' . $rmvs . '/' . $ig[0])) {
                                                                                    ?>
                                                                                        <img loading="lazy" src="pco/Room Uploads/<?php echo $ghotel; ?>/<?php echo $rmvs; ?>/<?php echo $ig[0]; ?>" alt="" loading="lazy">
                                                                                        ...
                                                                                        <div class="container-lg contentcat" style="background: rgb(42, 42, 58);">
                                                                                            <div class="row">
                                                                                                <div class="col-lg-8">
                                                                                                    ...
                                                                                                    for ($ximg = 0; $ximg < count($ig); $ximg++) {
                                                                                                    ?>
                                                                                                        <div class="mySlidesCss mySlidesSH<?php echo $x ?>">
                                                                                                            <img loading="lazy" src="pco/Room Uploads/<?php echo $ghotel; ?>/<?php echo $rmvs; ?>/<?php echo $ig[$ximg]; ?>" style="width:100%" loading="lazy">
                                                                                                    ...
                                                                                                    <a class="prevs" onclick="plusSlides<?php echo $x ?>(-1)">❮</a>
                                                                                                    <a class="nexts" onclick="plusSlides<?php echo $x ?>(1)">❯</a>
                                                                                                ...
                                                                                                <div class="col-lg-4 bg-white" style="border-radius:0px 20px;">
                                                                                                    ...
                                                                                                    <div class="">
                                                                                                        <div id="sideright">
                                                                                                            ...
                                                                                                            <div class="tab-content" id="myTabContent">
                                                                                                                        ...
                                                                                                                        <div class="col-md-6">
                                                                                                                            ...
                                                                                                                            <p class="infoBox">
                                                                                                                                ...
                                                                                                                                <span>
                                                                                                                                    ...
                                                                                                                                    foreach ($adultsallowed as $abc) {
                                                                                                                                        echo $dd;
                                                                                                                                        $adultsforu = $abc[$opp . $baba];
                                                                                                                                        for ($ac = 0; $ac < intval($adultsforu); $ac++) {
                                                                                                                                    ?>
                                                                                                                                            <img loading="lazy" style='max-width:8px;' src="img/terms/terms_icon_22.png" loading="lazy">

                                                                                                                                        <?php
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    foreach ($childrenallowed as $abc2) {
                                                                                                                                        $childrenforu = $abc2[$dd . $rmvs];
                                                                                                                                        for ($ac = 0; $ac < intval($childrenforu); $ac++) {
                                                                                                                                        ?>
                                                                                                                                            <img loading="lazy" style='max-width:8px;' src="img/terms/terms_icon_3333.png" loading="lazy">
                                                                                                                                    <?php
                                                                                                                                        }
                                                                                                                                    }
                                                                                                                                    ?></span>
                                                                                                                        ...
                                                                                                                        <div class="col-md-6">
                                                                                                                            <p class="infoBox">
                                                                                                                                ...
                                                                                                                                <span>
                                                                                                                                    ...
                                                                                                                                    foreach ($roomsizes as $abbc2) {

                                                                                                                                        $roomsizesn = $abbc2[$ghotel . $roomsnames[$x]];
                                                                                                                    ...
                                                                                                                    <div>
                                                                                                                        ...
                                                                                                                        <div class='container'>
                                                                                                                            <div class='row'>
                                                                                                                                ...
                                                                                                                                ?>
                                                                                                                                    <div class='col-sm'>
                                                                                                                                        ...
                                                                                                                                        <ul class="small text-black-50">
                                                                                                                                            ...
                                                                                                                                            <?php
                                                                                                                                            foreach ($inroomfa as $inroom) {
                                                                                                                                            ?>

                                                                                                                                                <li class="my-2"><?php echo $inroom; ?></li>
                                                                                                                                ...
                                                                                                                                if (!empty($privatebathroomf[$x])) {

                                                                                                                                    $privatebathroomfa = explode(",", $privatebathroomf[$x])
                                                                                                                                ?>
                                                                                                                                    <div class='col-sm'>
                                                                                                                                        ...
                                                                                                                                        <ul class="small text-black-50">
                                                                                                                                            ...
                                                                                                                                            <?php
                                                                                                                                            foreach ($privatebathroomfa as $inroom) {
                                                                                                                                            ?>
                                                                                                                                ...
                                                                                                                                if (!empty($discountedf[$x])) {

                                                                                                                                    $discountedfa = explode(",", $discountedf[$x])
                                                                                                                                ?>
                                                                                                                                    <div class='col-sm'>
                                                                                                                                        ...
                                                                                                                                        <ul class="small text-black-50">
                                                                                                                                            ...
                                                                                                                                            <?php
                                                                                                                                            foreach ($discountedfa as $inroom) {
                                                                                                                                            ?>
                                                                                                                                ...
                                                                                                                                if (!empty($complimentaryf[$x])) {

                                                                                                                                    $complimentaryfa = explode(",", $complimentaryf[$x])
                                                                                                                                ?>
                                                                                                                                    <div class='col-sm'>
                                                                                                                                        ...
                                                                                                                                        <ul class="small text-black-50">
                                                                                                                                            ...
                                                                                                                                            <?php
                                                                                                                                            foreach ($complimentaryfa as $inroom) {
                                                                                                                                            ?>
                                                                                                                ...
                                                                                                                <div class="tab-pane fade" id="contact<?php echo $ban; ?>" role="tabpanel" aria-labelledby="contact-tab">
                                                                                                                    ...
                                                                                                                    $roomscancellationnamesa = explode('_@_', $roomscancellationnames[$x]);

                                                                                                                    $roomscancellationa = explode('_@_', $roomscancellation[$x]);
                                                                                                                    foreach ($roomscancellationnamesa as $mkm) {


                                                                                                                        echo '<h4>' . $mkm . '</h4>';
                                                                                                                    }

                                                                                                                    foreach ($roomscancellationa as $mkma) {
                                                                                                        ...
                                                                                                        <div class="btn-bg">
                                                                                                            <a href='hotelsingle.php?hotel=<?php echo $ghotel; ?>&city=<?php echo $gcity; ?>&country=<?php echo $gcountry; ?>&sendcategory=<?php echo $gsendcategory; ?>'>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="row col-md-12 list-c-main">
                                                                                                    ...
                                                                                                    <div class="col-md-2">
                                                                                                        ...
                                                                                                        for ($ximg = 0; $ximg < count($ig); $ximg++) {
                                                                                                        ?>
                                                                                                            <div class="numbertext" id="numbertext<?= $ximg ?>"> <?= $ximg + 1 ?> / <?= count($ig) ?></div>
                                                                                                        <?php
                                                                                                        }
                                                                                                        ?>
                                                                                            ...
                                                                                            <div style="padding:10px;" class="row myCat<?php echo $x ?>" onclick="currentCat<?php echo $x ?>(1)">
                                                                                                ...
                                                                                                foreach ($ig as $index => $aa) {

                                                                                                ?>
                                                                                                    <div class="column" style="height: 57px; width:100px; overflow:hidden; margin-right: 10px; ">
                                                                                                        <img loading="lazy" class="demo<?php echo $ban ?> cursor" src="pco/Room Uploads/<?php echo $ghotel; ?>/<?php echo $rmvs; ?>/<?php echo $aa; ?>" style="width:100%" loading="lazy" onclick="currentSlide<?php echo $ban ?>(<?= $index ?>)" alt="" style="<?php if ($index == 0) {
                                                                                            ...
                                                                                            <!-- <div class="row myCat" onclick="currentCat(2)">
                                                                                                <div class="column">
                                                                                                    <img loading="lazy" class="demo cursor" src="img/img_mountains.jpg" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
                                                                                                </div>
                                                                                                <div class="column">
                                                                                                    <img loading="lazy" class="demo cursor" src="img/img_lights.jpg" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="row myCat" onclick="currentCat(3)">
                                                                                                <div class="column">
                                                                                                    <img loading="lazy" class="demo cursor" src="img/img_nature.jpg" style="width:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
                                                                                                </div>    
                                                                                                <div class="column">
                                                                                                    <img loading="lazy" class="demo cursor" src="img/img_snow.jpg" style="width:100%" onclick="currentSlide(6)" alt="Snowy Mountains">
                                                                                                </div>
                                                                                            </div> -->
                                                                                        </div>
                                                                            ...
                                                                            ?>
                                                                                    <script>
                                                                                        images_count<?php echo $x  ?> = images_count<?php echo $x  ?> + 1;
                                                                                    </script>
                                                                            <?php
                                                                            ...
                                                                            <script>
                                                                                ...
                                                                                function showSlides<?php echo $x ?>(n) {
                                                                                    ...
                                                                                    let i;
                                                                                    let slides = document.getElementsByClassName("mySlidesSH<?php echo $x ?>");
                                                                        ...
                                                                        <div style='border:1px solid #E8E8E8; padding-top:22px;<?php if ($index == 0) {
                                                                            ...
                                                                            $abc = '';
                                                                            $sqlprice = "SELECT * FROM setprices WHERE country='$cn'&& location='$ln' && hotel='$hn' && name='$roomsnames[$x]' && (class='FIT' || class='') && approved='approved'";
                                        ...
                                        <nonsense id='filtereddatafromajax'>
                                            ...
                                            ?>
                                                ...
                                                ?>
                                                    ...
                                                    <div style='border-radius:25px; display:none; ' class="searchitem">
                                                        ...
                                                        <div class="item_details" style="border-right: 1px solid rgba(0, 0, 0, 0.3);  padding-top: 15px; padding-left:22px; padding-right:22px; min-width: 321px;">
                                                            <div class="item_main_title">
                                                            ...
                                                            <div class="room_galary">
                                                                ...
                                                                ?>
                                                                        ...
                                                                        <a href="pco/Hotel Images/<?php echo $dd; ?>/<?php echo $zi; ?>" data-lightbox="room_gal_<?php echo $gals; ?>">
                                                                            ...
                                                                            ?>
                                                                                <img loading="lazy" src="pco/Hotel Images/<?php echo $dd; ?>/<?php echo $zi; ?>" alt="">
                                                                            <?php
                                                                            } else {
                                                                            ?>
                                                                                <img loading="lazy" src="img/placeholders/HotelImageSmall.png" alt="">
                                                                            <?php
                                                                            }
                                                                            ?>
                                                        ...
                                                        <form class='notranslate' action='#' method='POST' style="position:relative;">
                                                                ...
                                                                <div style='display:flex; border: none !important; padding-top:15px; padding-bottom:65px;' class="other_room_list">
                                                                    ...
                                                                    <div class="RoomsList<?= $gals ?>" style="min-width:100%; height:auto; ">
                                                                        ...
                                                                        ?>
                                                                                ...
                                                                                <div class='row d-flex content2<?= $gals ?>' style="margin-bottom:10px; display:none !important;">
                                                                                        ...
                                                                                        <div style='padding:10px !important; border-bottom:0px;' class="room_box">
                                                                                            <div style='padding:0 !important;' class="inner_room_meta">
                                                                                                <div class="room_metas">
                                                                                                    ...
                                                                                                    <div class="col-md-12">
                                                                                                        <div class="form-control_input">
                                                                                                            <input data-ad='<?php echo $acb; ?>' data-id='<?php echo $adios; ?>' onchange='increaseprice(this); totall(this);' type="number" name='roomseachtype[]' min='0' max='<?php echo $allavailroomnumbers[$adiosaba]; ?>' class="roms<?php echo $acb; ?> form-control" value="0">
                                                                                                            <div class="pre_value"><i class="bi bi-people"></i>Rooms:</div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                    ...
                                                                                    <div style='border:1px solid #E8E8E8;<?php if ($index == 0) {
                                                                                        ...
                                                                                        <?php
                                                                                        $pricecompare = 'Select Dates';
                                                                                        $sqlprice = "SELECT * FROM setprices WHERE country='$selectedcountries[$nds]' && location='$selectedcities[$nds]' && hotel='$dd' && name='$bb' && (class='FIT' || class='') && approved='approved'";
                                                            ...
                                                            if ($index >= 2) {
                                                            ?>
                                                                <button class="theme_btnNew btn  bookNewBtnLoadMore" style="border-radius: 50%; padding: 7px 12px;" id="loadMore<?= $gals ?>"><i class="bi bi-chevron-down"></i></button>
                                                                <button class="theme_btnNew btn  bookNewBtnLoadMore" style="border-radius: 50%; padding: 7px 12px; display:none;" id="loadMoreu<?= $gals ?>"><i class="bi bi-chevron-up"></i></button>
                                                            <?php
                                                            } ?>
                                                            <input type='submit' name='submit' class="theme_btnNew btn  bookNewBtn" value='Book Now'>
                                                                        ...
                                                                        <div class="room_galary">
                                                                            ...
                                                                            ?>
                                                                                    ...
                                                                                    <a href="pco/Hotel Images/<?php echo $dd; ?>/<?php echo $zi2; ?>" data-lightbox="room_gal_1">
                                                                                        ...
                                                                                        <img loading="lazy" src="pco/Hotel Images/<?php echo $dd; ?>/<?php echo $zi2; ?>" alt="">
                                                                                    </a>
                                                                            <?php
                                                                                }
                                                                            }
                                                                            ...
                                                                            <div class="col-lg-8">
                                                                                ...
                                                                                ?>
                                                                                        <div class="mySlidesCss mySlides<?php echo $ban ?>">
                                                                                            <?php
                                                                                            $img_path_hotel_ban = 'pco/Room Uploads/' . $opp . '/' . $baba . '/' . $aa;
                                                                                            if (file_exists($img_path_hotel_ban)) {
                                                                                            ?>
                                                                                                <img loading="lazy" src="pco/Room Uploads/<?php echo $opp; ?>/<?php echo $baba; ?>/<?php echo $aa; ?>" style="width:100%">
                                                                                            <?php
                                                                                            } else {
                                                                                            ?>
                                                                                                <img loading="lazy" src="img/placeholders/293x266-hotel.png" style="width:100%">
                                                                                            <?php
                                                                                                        ...
                                                                                                        <p class="infoBox">
                                                                                                            ...
                                                                                                            <span>
                                                                                                                ...
                                                                                                                foreach ($adultsallowednew as $abc) {
                                                                                                                    ...
                                                                                                                    for ($ac = 0; $ac < intval($adultsforu); $ac++) {
                                                                                                                ?>
                                                                                                                        <img loading="lazy" style='max-width:8px;' src="img/terms/terms_icon_22.png">
                                                                                                                ...
                                                                                                                foreach ($childrenallowednew as $abc2) {
                                                                                                                    ...
                                                                                                                    for ($ac = 0; $ac < intval($childrenforu); $ac++) {
                                                                                                                    ?>
                                                                                                                        <img loading="lazy" style='max-width:8px;' src="img/terms/terms_icon_3333.png">
                                                                                                                <?php
                                                                                                                    }
                                                                                                                }
                                                                                                                ?></span>
                                                                        ...
                                                                        <div style="padding:10px;" class="row myCat<?php echo $ban ?>" onclick="currentCat<?php echo $ban ?>(1)">
                                                                            ...
                                                                            ?>
                                                                                    <div class="column" style="height: 57px; width:100px; overflow:hidden; margin-right: 10px; ">
                                                                                        ...
                                                                                        if (file_exists($img_path_hotel_ban)) {
                                                                                        ?>
                                                                                            <img loading="lazy" class="demo<?php echo $ban ?> cursor" src="pco/Room Uploads/<?php echo $opp; ?>/<?php echo $baba; ?>/<?php echo $aa; ?>" style="width:100%" onclick="currentSlide<?php echo $ban ?>(<?= $index ?>)" alt="" style="<?php if ($index == 0) {
                                                                                                                                                                                                                                                                                                                                        echo 'border-radius:5px 5px 0px 0px';
                                                                                                                                                                                                                                                                                                                                    } ?>">
                                                                                        <?php
                                                                                        } else {
                                                                                        ?>
                                                                                            <img loading="lazy" src="img/placeholders/roomImage.png" style="width:100%">
                                                                                        <?php
        ...
        <script>
            function filters() {
                ...
                const filterss = document.getElementsByClassName('hotelfil');
                for (let i = 0; i < filterss.length; i++) {

                    if (filterss.item(i).checked) {

                        fil += filterss.item(i).value + ',';
                ...
                const rfilterss = document.getElementsByClassName('roomfil');
                for (let i = 0; i < rfilterss.length; i++) {

                    if (rfilterss.item(i).checked) {

                        rfil += rfilterss.item(i).value + ',';
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        document.getElementById('filtereddatafromajax').innerHTML = result;
