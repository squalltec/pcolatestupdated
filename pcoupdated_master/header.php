...
<body>
  ...
  <style>
    ...
    *:not(.stylenotneeded) {
    ...
    #exampleModalCenter3signup .modal-header {
      border: none;
    }
    .badge{
    width: auto;
  ...
  <style>
    ...
    @keyframes example {
      ...
      10% {
        border-left: 0.4px solid #ffffff;
      }
      ...
      60% {
        border-left: 1.4px solid #ffe6e6;
      }

      70% {
        border-left: 1.5px solid #ff8080;
      }

      80% {
        border-left: 1.6px solid #ff8080;
      }

      90% {
        border-left: 1.7px solid #ff8080;
      }
  ...
  <a href='https://wa.me/+971506509976'> <img src='whatsappicon.png' style='max-width:80px;' class='whatsappp cs-hide_print' ></a>



  <div class="main-holder  ">
    <div class="cs-hide_print" style=' margin-top:-20px; width:100%; background-color:#dc3545; background-image: linear-gradient(45deg, #dc3545 0%, black 100%);'>
      <div class="topBar">
        ...
        <img id='langimg' data-toggle="modal" data-target="#exampleModalCenter" style=' max-width:30px; margin-left:20px; margin-top:10px;  float:left; ' src='flags/united-kingdom.png'>
        ...
        <div class="container">
          ...
          <div style='position: relative; z-index:2;' class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mx-auto mb-lg-0">
              ...
              <li class="nav-item">
                <a href="/become-partner.php" class="nav-link" href="#">Become a Partner</a>
              </li>
              <li class="nav-item">
                <a href="/subscriptions.php" class="nav-link" href="#">Subscription</a>
              </li>
              <li class="nav-item">
                <a href="/contact.php" class="nav-link" href="#">Contact</a>
              </li>
              <span class="mobileviewMenuItems">
                ...
                <li class="nav-item">
                  <nonsense class="nav-link" data-toggle="modal" data-target="#exampleModalCenter3">Agent Login | VIP Login</nonsense>
                </li>
              </span>
            ...
            <img id='googleplayy2' style=' width:20%;' src='img/webp/downbtn.webp'>
          ...
          <div class="notranslate modal-body">
            <div class='container'>
              <div class='row'>
                ...
                <p>To Book More than 9 Rooms Please Request it by Registering, Thanks</p>
